...
| WorkspaceService.save_recipe | self._save_recipe('save_recipe', request, row_id) | backend/src/app/core/workspace_service.py:342 |
...
| WorkspaceService.save_recipe | 料理の保存を本人の履歴へ記録する。 | backend/src/app/core/workspace_service.py:342 |
