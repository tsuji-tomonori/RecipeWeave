...
| row_id | uuid4() (backend/src/app/core/workspace_service.py:72) / identifier(item.id) (backend/src/app/core/workspace_service.py:281) / uuid4() (backend/src/app/core/workspace_service.py:295) |
...
| WorkspaceService.add_menu_item | self.finish(q) | backend/src/app/core/workspace_service.py:305 |
...
| WorkspaceService.add_menu_item | 確認した料理版・人数・材料別分量を献立へ保存する。 | backend/src/app/core/workspace_service.py:305 |
