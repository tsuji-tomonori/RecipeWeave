# SQL仕様: entity_product_version_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.product_version | R | created_at, drain_amount, form_id, id, net_amount, preparation_note, product_id, source_id, unit_id, valid_from, version, xmin |
