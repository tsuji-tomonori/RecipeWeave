...
| SQLバインド | 実装上の値の出所 |
|---|---|
| menu_id | menu_id (backend/src/app/core/workspace_service.py:188) / menu_id (backend/src/app/core/workspace_service.py:206) / self.menu_id (backend/src/app/core/workspace_service.py:324) |
| row_id | uuid4() (backend/src/app/core/workspace_service.py:72) / row_id (backend/src/app/core/workspace_service.py:324) |
...
| not q.run('q001_delete_item', row_id=row_id, menu_id=self.menu_id, user_id=self.user_id) | HTTPException(404, '献立の料理が見つかりません') | backend/src/app/core/workspace_service.py:321 |
...
| WorkspaceService.delete_menu_item | self.finish(q) | backend/src/app/core/workspace_service.py:321 |
...
| WorkspaceService.delete_menu_item | 現在の献立から本人の項目を取り除く。 | backend/src/app/core/workspace_service.py:321 |
