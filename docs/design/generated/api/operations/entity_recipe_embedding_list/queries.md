# SQL仕様: entity_recipe_embedding_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_embedding | R | content_hash, created_at, created_for_index, embedding, id, model_version, recipe_version_id, xmin |
