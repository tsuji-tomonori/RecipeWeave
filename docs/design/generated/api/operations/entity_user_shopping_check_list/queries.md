# SQL仕様: entity_user_shopping_check_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.user_shopping_check | R | amount, archived, checked_at, created_at, food_id, id, key, signature, unit_id, user_id, xmin |
