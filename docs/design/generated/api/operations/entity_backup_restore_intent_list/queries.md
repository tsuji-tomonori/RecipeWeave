# SQL仕様: entity_backup_restore_intent_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.backup_restore_intent | R | artifact_id, body_sha256, consumed_at, created_at, current_revision, expires_at, id, user_id, xmin |
