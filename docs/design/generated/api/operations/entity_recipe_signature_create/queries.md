# SQL仕様: entity_recipe_signature_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_signature | C | algorithm_version, canonical_payload, cluster_key, created_at, exact_hash, id, recipe_version_id, xmin |

バインド変数: algorithm_version, canonical_payload, cluster_key, exact_hash, recipe_version_id, row_id
