# SQL仕様: entity_resource_reservation_update
...
| recipeweave.resource_reservation | U | created_at, end_s, id, quantity, resource_id, start_s, task_id, xmin |
| recipeweave.session_task | R | id, session_id |

バインド変数: actor_id, end_s, expected_etag, quantity, resource_id, row_id, start_s, task_id
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.kitchen_resource | R | id, user_id |
