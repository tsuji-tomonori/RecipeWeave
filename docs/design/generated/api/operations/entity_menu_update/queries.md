...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.menu | U | created_at, id, name, revision, servings, user_id, xmin |

バインド変数: actor_id, expected_etag, name, row_id, servings, user_id
