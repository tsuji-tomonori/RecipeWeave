# SQL仕様: entity_step_input_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.step_input | U | created_at, fraction, id, material_id, step_id, xmin |

バインド変数: expected_etag, fraction, material_id, row_id, step_id
