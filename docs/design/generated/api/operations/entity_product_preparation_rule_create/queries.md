# SQL仕様: entity_product_preparation_rule_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.product_preparation_rule | C | allowed, created_at, id, operation_id, parameter_contract, product_version_id, source_id, use_original_container, xmin |

バインド変数: allowed, operation_id, parameter_contract, product_version_id, row_id, source_id, use_original_container
