...
| operation_id | CONTRACT.operation_id (backend/src/app/apis/entities/product_preparation_rule_create/router.py:17) / spec.operation_id (backend/src/app/core/entity_service.py:49) / spec.operation_id (backend/src/app/core/entity_service.py:108) / spec.operation_id (backend/src/app/core/entity_service.py:118) |
