...
定義元: `backend/src/app/apis/generation/advance_shard/router.py:31`
...
定義元: `backend/src/app/apis/generation/advance_shard/functions.py:11`
...
sequenceDiagram
    ...
    Function->>Callee: run_lease_operation(service, #39;advance_shard#39;, values)
    Callee-->>Function: 呼出結果（例外は呼出元へ伝播）
    break この経路の関数終了: return
        Function-->>Caller: run_lease_operation(service, #39;advance_shard#39;, values)
    end
```
