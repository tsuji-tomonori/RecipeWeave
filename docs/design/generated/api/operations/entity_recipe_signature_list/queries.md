# SQL仕様: entity_recipe_signature_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_signature | R | algorithm_version, canonical_payload, cluster_key, created_at, exact_hash, id, recipe_version_id, xmin |
