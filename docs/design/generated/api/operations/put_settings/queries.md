...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.kitchen_resource | U | active, resource_type_id, user_id |
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.user_exclusion | C | allergen_id, food_id, id, strict, user_id |
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.user_pantry_food | C | food_id, id, user_id |
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.kitchen_resource | U | active, id, resource_type_id, user_id |
| recipeweave.resource_type | R | id, name, status |
