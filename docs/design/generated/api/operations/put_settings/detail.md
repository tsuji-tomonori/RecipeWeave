...
| SQLバインド | 実装上の値の出所 |
|---|---|
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:353) / self.user_id (backend/src/app/core/workspace_service.py:355) / self.user_id (backend/src/app/core/workspace_service.py:357) / self.user_id (backend/src/app/core/workspace_service.py:359) / self.user_id (backend/src/app/core/workspace_service.py:360) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| food_id | identifier(food) (backend/src/app/core/workspace_service.py:355) / identifier(food) (backend/src/app/core/workspace_service.py:357) |
| row_id | uuid4() (backend/src/app/core/workspace_service.py:71) / uuid4() (backend/src/app/core/workspace_service.py:355) / uuid4() (backend/src/app/core/workspace_service.py:357) / uuid4() (backend/src/app/core/workspace_service.py:360) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:353) / self.user_id (backend/src/app/core/workspace_service.py:355) / self.user_id (backend/src/app/core/workspace_service.py:357) / self.user_id (backend/src/app/core/workspace_service.py:359) / self.user_id (backend/src/app/core/workspace_service.py:360) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| name | r['name'] (backend/src/app/core/workspace_service.py:137) / equipment (backend/src/app/core/workspace_service.py:359) / equipment (backend/src/app/core/workspace_service.py:360) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:353) / self.user_id (backend/src/app/core/workspace_service.py:355) / self.user_id (backend/src/app/core/workspace_service.py:357) / self.user_id (backend/src/app/core/workspace_service.py:359) / self.user_id (backend/src/app/core/workspace_service.py:360) |
...
| not existing and (not q.run('q007_add_equipment', row_id=uuid4(), user_id=self.user_id, name=equipment)) | HTTPException(422, '未登録の器具が含まれています') | backend/src/app/core/workspace_service.py:349 |
...
| WorkspaceService.put_settings | self.finish(q) | backend/src/app/core/workspace_service.py:349 |
...
| WorkspaceService.put_settings | 除外・常備・器具の選択を関連行として保存する。 | backend/src/app/core/workspace_service.py:349 |
