# SQL仕様: entity_recipe_version_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_version | R | base_servings, content_hash, created_at, description, id, output_amount, output_unit_id, published_at, recipe_id, release_id, status, validation, version, xmin |
