# SQL仕様: entity_step_parameter_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.step_parameter | C | bool_value, created_at, id, number_value, parameter_id, step_id, text_value, xmin |

バインド変数: bool_value, number_value, parameter_id, row_id, step_id, text_value
