# SQL仕様: entity_generation_shard_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_shard | R | created_at, end_ordinal, fence_token, id, lease_expires_at, lease_owner, next_ordinal, start_ordinal, state, template_id, xmin |
