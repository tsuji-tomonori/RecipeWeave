...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_shard | U | created_at, end_ordinal, fence_token, id, lease_expires_at, lease_owner, next_ordinal, start_ordinal, state, template_id, xmin |

バインド変数: expected_fence, lease_owner, lease_seconds, row_id
