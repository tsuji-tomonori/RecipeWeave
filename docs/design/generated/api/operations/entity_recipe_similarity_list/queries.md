# SQL仕様: entity_recipe_similarity_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_similarity | R | algorithm_version, created_at, explanation, id, left_version_id, right_version_id, score, xmin |
