# インターフェース: entity_allergen_create
...
"""アレルゲン概念の作成。具体例は専用型と操作別受入テストに対応する。"""
...
```json
{
  "description": "アレルゲン概念の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。",
  "operationId": "entity_allergen_create",
  "parameters": [],
  "requestBody": {
    "content": {
      "application/json": {
