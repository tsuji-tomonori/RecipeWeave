# SQL仕様: entity_recipe_embedding_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_embedding | U | content_hash, created_at, created_for_index, embedding, id, model_version, recipe_version_id, xmin |

バインド変数: content_hash, created_for_index, embedding, expected_etag, model_version, recipe_version_id, row_id
