# SQL仕様: entity_step_media_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.step_media | U | created_at, end_ms, id, media_id, start_ms, step_id, xmin |

バインド変数: end_ms, expected_etag, media_id, row_id, start_ms, step_id
