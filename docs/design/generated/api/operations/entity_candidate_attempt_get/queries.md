# SQL仕様: entity_candidate_attempt_get
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.candidate_attempt | R | attempts, created_at, design_key, id, job_id, ordinal, reason_code, recipe_version_id, state, template_id, xmin |
