...
| SQLバインド | 実装上の値の出所 |
|---|---|
| food_id | identifier(value.food_id) (backend/src/app/core/workspace_service.py:210) / food_id (backend/src/app/core/workspace_service.py:403) / food_id (backend/src/app/core/workspace_service.py:411) / food_id (backend/src/app/core/workspace_service.py:412) / str(candidate.food_id) (backend/src/app/core/workspace_service.py:464) |
| form | r['form'] (backend/src/app/core/workspace_service.py:93) / value.form (backend/src/app/core/workspace_service.py:210) |
| unit | unit (backend/src/app/core/workspace_service.py:43) / value.quantity.unit (backend/src/app/core/workspace_service.py:210) / food.default_unit (backend/src/app/core/workspace_service.py:412) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:65) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:72) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:85) / self.user_id (backend/src/app/core/workspace_service.py:133) / self.user_id (backend/src/app/core/workspace_service.py:106) / self.user_id (backend/src/app/core/workspace_service.py:120) / self.user_id (backend/src/app/core/workspace_service.py:148) / self.user_id (backend/src/app/core/workspace_service.py:159) / self.user_id (backend/src/app/core/workspace_service.py:172) / self.user_id (backend/src/app/core/workspace_service.py:188) / self.user_id (backend/src/app/core/workspace_service.py:206) / self.user_id (backend/src/app/core/workspace_service.py:210) / self.user_id (backend/src/app/core/workspace_service.py:225) / self.user_id (backend/src/app/core/workspace_service.py:396) / self.user_id (backend/src/app/core/workspace_service.py:403) / self.user_id (backend/src/app/core/workspace_service.py:411) / self.user_id (backend/src/app/core/workspace_service.py:430) / self.user_id (backend/src/app/core/workspace_service.py:456) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| amount | Decimal(str(value.quantity.value)) if value.quantity.value is not None else None (backend/src/app/core/workspace_service.py:226) / resolved['amount'] (backend/src/app/core/workspace_service.py:468) |
| expires_on | expires (backend/src/app/core/workspace_service.py:230) |
| form_id | resolved['form_id'] (backend/src/app/core/workspace_service.py:468) |
| import_id | import_id (backend/src/app/core/workspace_service.py:430) / import_id (backend/src/app/core/workspace_service.py:456) / import_id (backend/src/app/core/workspace_service.py:467) / import_id (backend/src/app/core/workspace_service.py:468) |
| location | DISPLAY_LOCATIONS[r['location']] (backend/src/app/core/workspace_service.py:94) / '冷蔵' (backend/src/app/core/workspace_service.py:142) / LOCATIONS[value.location] (backend/src/app/core/workspace_service.py:231) |
| priority | r['priority'] == 'use_first' (backend/src/app/core/workspace_service.py:95) / 'use_first' if value.priority else 'normal' (backend/src/app/core/workspace_service.py:232) |
| quality | 'unknown' if value.quantity.value is None else 'known' (backend/src/app/core/workspace_service.py:229) |
| row_id | uuid4() (backend/src/app/core/workspace_service.py:72) / uuid4() (backend/src/app/core/workspace_service.py:411) / uuid5(food_id, 'standard') (backend/src/app/core/workspace_service.py:412) / lot_id (backend/src/app/core/workspace_service.py:467) / uuid5(import_id, f'receipt-line:{number}') (backend/src/app/core/workspace_service.py:468) |
| unit_id | resolved['unit_id'] (backend/src/app/core/workspace_service.py:468) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:65) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:72) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:85) / self.user_id (backend/src/app/core/workspace_service.py:133) / self.user_id (backend/src/app/core/workspace_service.py:106) / self.user_id (backend/src/app/core/workspace_service.py:120) / self.user_id (backend/src/app/core/workspace_service.py:148) / self.user_id (backend/src/app/core/workspace_service.py:159) / self.user_id (backend/src/app/core/workspace_service.py:172) / self.user_id (backend/src/app/core/workspace_service.py:188) / self.user_id (backend/src/app/core/workspace_service.py:206) / self.user_id (backend/src/app/core/workspace_service.py:210) / self.user_id (backend/src/app/core/workspace_service.py:225) / self.user_id (backend/src/app/core/workspace_service.py:396) / self.user_id (backend/src/app/core/workspace_service.py:403) / self.user_id (backend/src/app/core/workspace_service.py:411) / self.user_id (backend/src/app/core/workspace_service.py:430) / self.user_id (backend/src/app/core/workspace_service.py:456) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| hash | request.image_hash (backend/src/app/core/workspace_service.py:430) / request.image_hash (backend/src/app/core/workspace_service.py:456) |
| import_id | import_id (backend/src/app/core/workspace_service.py:430) / import_id (backend/src/app/core/workspace_service.py:456) / import_id (backend/src/app/core/workspace_service.py:467) / import_id (backend/src/app/core/workspace_service.py:468) |
| signature | r['signature'] (backend/src/app/core/workspace_service.py:153) / request.purchase_signature + '%' (backend/src/app/core/workspace_service.py:430) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:65) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:72) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:85) / self.user_id (backend/src/app/core/workspace_service.py:133) / self.user_id (backend/src/app/core/workspace_service.py:106) / self.user_id (backend/src/app/core/workspace_service.py:120) / self.user_id (backend/src/app/core/workspace_service.py:148) / self.user_id (backend/src/app/core/workspace_service.py:159) / self.user_id (backend/src/app/core/workspace_service.py:172) / self.user_id (backend/src/app/core/workspace_service.py:188) / self.user_id (backend/src/app/core/workspace_service.py:206) / self.user_id (backend/src/app/core/workspace_service.py:210) / self.user_id (backend/src/app/core/workspace_service.py:225) / self.user_id (backend/src/app/core/workspace_service.py:396) / self.user_id (backend/src/app/core/workspace_service.py:403) / self.user_id (backend/src/app/core/workspace_service.py:411) / self.user_id (backend/src/app/core/workspace_service.py:430) / self.user_id (backend/src/app/core/workspace_service.py:456) |
...
| hash | request.image_hash (backend/src/app/core/workspace_service.py:430) / request.image_hash (backend/src/app/core/workspace_service.py:456) |
| import_id | import_id (backend/src/app/core/workspace_service.py:430) / import_id (backend/src/app/core/workspace_service.py:456) / import_id (backend/src/app/core/workspace_service.py:467) / import_id (backend/src/app/core/workspace_service.py:468) |
| key | r['client_key'] (backend/src/app/core/workspace_service.py:152) / f'{request.purchase_signature}:{import_id}' (backend/src/app/core/workspace_service.py:456) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:65) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:72) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:85) / self.user_id (backend/src/app/core/workspace_service.py:133) / self.user_id (backend/src/app/core/workspace_service.py:106) / self.user_id (backend/src/app/core/workspace_service.py:120) / self.user_id (backend/src/app/core/workspace_service.py:148) / self.user_id (backend/src/app/core/workspace_service.py:159) / self.user_id (backend/src/app/core/workspace_service.py:172) / self.user_id (backend/src/app/core/workspace_service.py:188) / self.user_id (backend/src/app/core/workspace_service.py:206) / self.user_id (backend/src/app/core/workspace_service.py:210) / self.user_id (backend/src/app/core/workspace_service.py:225) / self.user_id (backend/src/app/core/workspace_service.py:396) / self.user_id (backend/src/app/core/workspace_service.py:403) / self.user_id (backend/src/app/core/workspace_service.py:411) / self.user_id (backend/src/app/core/workspace_service.py:430) / self.user_id (backend/src/app/core/workspace_service.py:456) |
...
| form_id | resolved['form_id'] (backend/src/app/core/workspace_service.py:468) |
| import_id | import_id (backend/src/app/core/workspace_service.py:430) / import_id (backend/src/app/core/workspace_service.py:456) / import_id (backend/src/app/core/workspace_service.py:467) / import_id (backend/src/app/core/workspace_service.py:468) |
| line_no | number (backend/src/app/core/workspace_service.py:468) |
| lot_id | lot_id (backend/src/app/core/workspace_service.py:468) |
| name | r['name'] (backend/src/app/core/workspace_service.py:138) / food.name.strip() (backend/src/app/core/workspace_service.py:403) / candidate.raw_text (backend/src/app/core/workspace_service.py:468) |
| row_id | uuid4() (backend/src/app/core/workspace_service.py:72) / uuid4() (backend/src/app/core/workspace_service.py:411) / uuid5(food_id, 'standard') (backend/src/app/core/workspace_service.py:412) / lot_id (backend/src/app/core/workspace_service.py:467) / uuid5(import_id, f'receipt-line:{number}') (backend/src/app/core/workspace_service.py:468) |
| unit_id | resolved['unit_id'] (backend/src/app/core/workspace_service.py:468) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| manifest | hashlib.sha256(b'private-catalog-v1').hexdigest() (backend/src/app/core/workspace_service.py:396) |
| release_id | release_id (backend/src/app/core/workspace_service.py:396) / release_id (backend/src/app/core/workspace_service.py:403) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:65) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:72) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:85) / self.user_id (backend/src/app/core/workspace_service.py:133) / self.user_id (backend/src/app/core/workspace_service.py:106) / self.user_id (backend/src/app/core/workspace_service.py:120) / self.user_id (backend/src/app/core/workspace_service.py:148) / self.user_id (backend/src/app/core/workspace_service.py:159) / self.user_id (backend/src/app/core/workspace_service.py:172) / self.user_id (backend/src/app/core/workspace_service.py:188) / self.user_id (backend/src/app/core/workspace_service.py:206) / self.user_id (backend/src/app/core/workspace_service.py:210) / self.user_id (backend/src/app/core/workspace_service.py:225) / self.user_id (backend/src/app/core/workspace_service.py:396) / self.user_id (backend/src/app/core/workspace_service.py:403) / self.user_id (backend/src/app/core/workspace_service.py:411) / self.user_id (backend/src/app/core/workspace_service.py:430) / self.user_id (backend/src/app/core/workspace_service.py:456) |
| version | int(revision[0]['revision']) if revision else 0 (backend/src/app/core/workspace_service.py:167) / f'private:{self.user_id}' (backend/src/app/core/workspace_service.py:396) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| code | f'USER-{food_id}' (backend/src/app/core/workspace_service.py:403) |
| food_id | identifier(value.food_id) (backend/src/app/core/workspace_service.py:210) / food_id (backend/src/app/core/workspace_service.py:403) / food_id (backend/src/app/core/workspace_service.py:411) / food_id (backend/src/app/core/workspace_service.py:412) / str(candidate.food_id) (backend/src/app/core/workspace_service.py:464) |
| name | r['name'] (backend/src/app/core/workspace_service.py:138) / food.name.strip() (backend/src/app/core/workspace_service.py:403) / candidate.raw_text (backend/src/app/core/workspace_service.py:468) |
| release_id | release_id (backend/src/app/core/workspace_service.py:396) / release_id (backend/src/app/core/workspace_service.py:403) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:65) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:72) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:85) / self.user_id (backend/src/app/core/workspace_service.py:133) / self.user_id (backend/src/app/core/workspace_service.py:106) / self.user_id (backend/src/app/core/workspace_service.py:120) / self.user_id (backend/src/app/core/workspace_service.py:148) / self.user_id (backend/src/app/core/workspace_service.py:159) / self.user_id (backend/src/app/core/workspace_service.py:172) / self.user_id (backend/src/app/core/workspace_service.py:188) / self.user_id (backend/src/app/core/workspace_service.py:206) / self.user_id (backend/src/app/core/workspace_service.py:210) / self.user_id (backend/src/app/core/workspace_service.py:225) / self.user_id (backend/src/app/core/workspace_service.py:396) / self.user_id (backend/src/app/core/workspace_service.py:403) / self.user_id (backend/src/app/core/workspace_service.py:411) / self.user_id (backend/src/app/core/workspace_service.py:430) / self.user_id (backend/src/app/core/workspace_service.py:456) |
...
| not form | HTTPException(422, '食材・形態・単位の組合せが見つかりません') | backend/src/app/core/workspace_service.py:209 |
| food.components_known or food.component_food_ids or food.aliases | HTTPException(422, '独自食材の構成や別名はこの操作では確定できません') | backend/src/app/core/workspace_service.py:391 |
| not q.run('q022_custom_form', row_id=uuid5(food_id, 'standard'), food_id=food_id, unit=food.default_unit) | HTTPException(422, '食材の単位が見つかりません') | backend/src/app/core/workspace_service.py:391 |
| any((r['id'] == import_id for r in duplicate)) or (duplicate and (not request.allow_duplicate)) | HTTPException(409, 'このレシートは登録済みです。重複を確認してください') | backend/src/app/core/workspace_service.py:426 |
| any((c.selected and (not c.food_id or c.status == 'excluded') for c in request.candidates)) | HTTPException(422, '選択した行の食材を確認してください') | backend/src/app/core/workspace_service.py:426 |
| any((c.quantity.value == 0 for c in selected)) | HTTPException(422, 'レシートの数量は0より大きい数か数量不明にしてください') | backend/src/app/core/workspace_service.py:426 |
| not selected | HTTPException(422, '在庫に入れる食材を一つ以上選んでください') | backend/src/app/core/workspace_service.py:426 |
| food.id not in {c.food_id for c in selected} | HTTPException(422, '選択されていない独自食材は登録できません') | backend/src/app/core/workspace_service.py:426 |
...
| WorkspaceService._stock | {**form[0], 'user_id': self.user_id, 'amount': Decimal(str(value.quantity.value)) if value.quantity.value is not None else None, 'quality': 'unknown' if value.quantity.value is None else 'known', 'expires_on': expires, 'location': LOCATIONS[value.location], 'priority': 'use_first' if value.priority else 'normal'} | backend/src/app/core/workspace_service.py:209 |
| WorkspaceService.commit_receipt | self.finish(q) | backend/src/app/core/workspace_service.py:426 |
...
| WorkspaceService._stock | 個別説明なし | backend/src/app/core/workspace_service.py:209 |
| WorkspaceService._custom_food | 個別説明なし | backend/src/app/core/workspace_service.py:391 |
| WorkspaceService.commit_receipt | 確認済み商品だけを在庫へ登録し、同じ要求の二重反映を防ぐ。 | backend/src/app/core/workspace_service.py:426 |
