...
| SQLバインド | 実装上の値の出所 |
|---|---|
| food_id | identifier(value.food_id) (backend/src/app/core/workspace_service.py:209) / food_id (backend/src/app/core/workspace_service.py:402) / food_id (backend/src/app/core/workspace_service.py:410) / food_id (backend/src/app/core/workspace_service.py:411) / str(candidate.food_id) (backend/src/app/core/workspace_service.py:463) |
| form | r['form'] (backend/src/app/core/workspace_service.py:92) / value.form (backend/src/app/core/workspace_service.py:209) |
| unit | unit (backend/src/app/core/workspace_service.py:42) / value.quantity.unit (backend/src/app/core/workspace_service.py:209) / food.default_unit (backend/src/app/core/workspace_service.py:411) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:209) / self.user_id (backend/src/app/core/workspace_service.py:224) / self.user_id (backend/src/app/core/workspace_service.py:395) / self.user_id (backend/src/app/core/workspace_service.py:402) / self.user_id (backend/src/app/core/workspace_service.py:410) / self.user_id (backend/src/app/core/workspace_service.py:429) / self.user_id (backend/src/app/core/workspace_service.py:455) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| amount | Decimal(str(value.quantity.value)) if value.quantity.value is not None else None (backend/src/app/core/workspace_service.py:225) / resolved['amount'] (backend/src/app/core/workspace_service.py:467) |
| expires_on | expires (backend/src/app/core/workspace_service.py:229) |
| form_id | resolved['form_id'] (backend/src/app/core/workspace_service.py:467) |
| import_id | import_id (backend/src/app/core/workspace_service.py:429) / import_id (backend/src/app/core/workspace_service.py:455) / import_id (backend/src/app/core/workspace_service.py:466) / import_id (backend/src/app/core/workspace_service.py:467) |
...
| row_id | uuid4() (backend/src/app/core/workspace_service.py:71) / uuid4() (backend/src/app/core/workspace_service.py:410) / uuid5(food_id, 'standard') (backend/src/app/core/workspace_service.py:411) / lot_id (backend/src/app/core/workspace_service.py:466) / uuid5(import_id, f'receipt-line:{number}') (backend/src/app/core/workspace_service.py:467) |
| unit_id | resolved['unit_id'] (backend/src/app/core/workspace_service.py:467) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:209) / self.user_id (backend/src/app/core/workspace_service.py:224) / self.user_id (backend/src/app/core/workspace_service.py:395) / self.user_id (backend/src/app/core/workspace_service.py:402) / self.user_id (backend/src/app/core/workspace_service.py:410) / self.user_id (backend/src/app/core/workspace_service.py:429) / self.user_id (backend/src/app/core/workspace_service.py:455) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| hash | request.image_hash (backend/src/app/core/workspace_service.py:429) / request.image_hash (backend/src/app/core/workspace_service.py:455) |
| import_id | import_id (backend/src/app/core/workspace_service.py:429) / import_id (backend/src/app/core/workspace_service.py:455) / import_id (backend/src/app/core/workspace_service.py:466) / import_id (backend/src/app/core/workspace_service.py:467) |
| signature | r['signature'] (backend/src/app/core/workspace_service.py:152) / request.purchase_signature + '%' (backend/src/app/core/workspace_service.py:429) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:209) / self.user_id (backend/src/app/core/workspace_service.py:224) / self.user_id (backend/src/app/core/workspace_service.py:395) / self.user_id (backend/src/app/core/workspace_service.py:402) / self.user_id (backend/src/app/core/workspace_service.py:410) / self.user_id (backend/src/app/core/workspace_service.py:429) / self.user_id (backend/src/app/core/workspace_service.py:455) |
...
| hash | request.image_hash (backend/src/app/core/workspace_service.py:429) / request.image_hash (backend/src/app/core/workspace_service.py:455) |
| import_id | import_id (backend/src/app/core/workspace_service.py:429) / import_id (backend/src/app/core/workspace_service.py:455) / import_id (backend/src/app/core/workspace_service.py:466) / import_id (backend/src/app/core/workspace_service.py:467) |
| key | r['client_key'] (backend/src/app/core/workspace_service.py:151) / f'{request.purchase_signature}:{import_id}' (backend/src/app/core/workspace_service.py:455) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:209) / self.user_id (backend/src/app/core/workspace_service.py:224) / self.user_id (backend/src/app/core/workspace_service.py:395) / self.user_id (backend/src/app/core/workspace_service.py:402) / self.user_id (backend/src/app/core/workspace_service.py:410) / self.user_id (backend/src/app/core/workspace_service.py:429) / self.user_id (backend/src/app/core/workspace_service.py:455) |
...
| form_id | resolved['form_id'] (backend/src/app/core/workspace_service.py:467) |
| import_id | import_id (backend/src/app/core/workspace_service.py:429) / import_id (backend/src/app/core/workspace_service.py:455) / import_id (backend/src/app/core/workspace_service.py:466) / import_id (backend/src/app/core/workspace_service.py:467) |
| line_no | number (backend/src/app/core/workspace_service.py:467) |
| lot_id | lot_id (backend/src/app/core/workspace_service.py:467) |
| name | r['name'] (backend/src/app/core/workspace_service.py:137) / food.name.strip() (backend/src/app/core/workspace_service.py:402) / candidate.raw_text (backend/src/app/core/workspace_service.py:467) |
| row_id | uuid4() (backend/src/app/core/workspace_service.py:71) / uuid4() (backend/src/app/core/workspace_service.py:410) / uuid5(food_id, 'standard') (backend/src/app/core/workspace_service.py:411) / lot_id (backend/src/app/core/workspace_service.py:466) / uuid5(import_id, f'receipt-line:{number}') (backend/src/app/core/workspace_service.py:467) |
| unit_id | resolved['unit_id'] (backend/src/app/core/workspace_service.py:467) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| manifest | hashlib.sha256(b'private-catalog-v1').hexdigest() (backend/src/app/core/workspace_service.py:395) |
| release_id | release_id (backend/src/app/core/workspace_service.py:395) / release_id (backend/src/app/core/workspace_service.py:402) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:209) / self.user_id (backend/src/app/core/workspace_service.py:224) / self.user_id (backend/src/app/core/workspace_service.py:395) / self.user_id (backend/src/app/core/workspace_service.py:402) / self.user_id (backend/src/app/core/workspace_service.py:410) / self.user_id (backend/src/app/core/workspace_service.py:429) / self.user_id (backend/src/app/core/workspace_service.py:455) |
| version | int(revision[0]['revision']) if revision else 0 (backend/src/app/core/workspace_service.py:166) / f'private:{self.user_id}' (backend/src/app/core/workspace_service.py:395) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| code | f'USER-{food_id}' (backend/src/app/core/workspace_service.py:402) |
| food_id | identifier(value.food_id) (backend/src/app/core/workspace_service.py:209) / food_id (backend/src/app/core/workspace_service.py:402) / food_id (backend/src/app/core/workspace_service.py:410) / food_id (backend/src/app/core/workspace_service.py:411) / str(candidate.food_id) (backend/src/app/core/workspace_service.py:463) |
| name | r['name'] (backend/src/app/core/workspace_service.py:137) / food.name.strip() (backend/src/app/core/workspace_service.py:402) / candidate.raw_text (backend/src/app/core/workspace_service.py:467) |
| release_id | release_id (backend/src/app/core/workspace_service.py:395) / release_id (backend/src/app/core/workspace_service.py:402) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:209) / self.user_id (backend/src/app/core/workspace_service.py:224) / self.user_id (backend/src/app/core/workspace_service.py:395) / self.user_id (backend/src/app/core/workspace_service.py:402) / self.user_id (backend/src/app/core/workspace_service.py:410) / self.user_id (backend/src/app/core/workspace_service.py:429) / self.user_id (backend/src/app/core/workspace_service.py:455) |
...
| food.components_known or food.component_food_ids or food.aliases | HTTPException(422, '独自食材の構成や別名はこの操作では確定できません') | backend/src/app/core/workspace_service.py:390 |
| not q.run('q022_custom_form', row_id=uuid5(food_id, 'standard'), food_id=food_id, unit=food.default_unit) | HTTPException(422, '食材の単位が見つかりません') | backend/src/app/core/workspace_service.py:390 |
| any((r['id'] == import_id for r in duplicate)) or (duplicate and (not request.allow_duplicate)) | HTTPException(409, 'このレシートは登録済みです。重複を確認してください') | backend/src/app/core/workspace_service.py:425 |
| any((c.selected and (not c.food_id or c.status == 'excluded') for c in request.candidates)) | HTTPException(422, '選択した行の食材を確認してください') | backend/src/app/core/workspace_service.py:425 |
| any((c.quantity.value == 0 for c in selected)) | HTTPException(422, 'レシートの数量は0より大きい数か数量不明にしてください') | backend/src/app/core/workspace_service.py:425 |
| not selected | HTTPException(422, '在庫に入れる食材を一つ以上選んでください') | backend/src/app/core/workspace_service.py:425 |
| food.id not in {c.food_id for c in selected} | HTTPException(422, '選択されていない独自食材は登録できません') | backend/src/app/core/workspace_service.py:425 |
...
| WorkspaceService.commit_receipt | self.finish(q) | backend/src/app/core/workspace_service.py:425 |
...
| WorkspaceService._custom_food | 個別説明なし | backend/src/app/core/workspace_service.py:390 |
| WorkspaceService.commit_receipt | 確認済み商品だけを在庫へ登録し、同じ要求の二重反映を防ぐ。 | backend/src/app/core/workspace_service.py:425 |
