# SQL仕様: entity_generation_policy_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_policy | C | created_at, id, model_identifier, parameter_json, prompt_template, release_id, schema_version, version, xmin |

バインド変数: model_identifier, parameter_json, prompt_template, release_id, row_id, schema_version, version
