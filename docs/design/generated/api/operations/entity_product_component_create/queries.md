# SQL仕様: entity_product_component_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.product_component | C | amount, created_at, form_id, id, name, product_version_id, quality, unit_id, xmin |

バインド変数: amount, form_id, name, product_version_id, quality, row_id, unit_id
