# インターフェース: entity_operation_create
...
"""標準調理動作の作成。具体例は専用型と操作別受入テストに対応する。"""
...
```json
{
  "description": "標準調理動作の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。",
  "operationId": "entity_operation_create",
  "parameters": [],
  "requestBody": {
    "content": {
      "application/json": {
