# 詳細設計: create_custom_food

[詳細](detail.md) / [入出力](interface.md) / [ログ](messages.md) / [SQL](queries.md) / [シーケンス](sequence.md) / [要因別試験](tests.md) / [API一覧](../../README.md)

実装から自動生成。手編集禁止。`uv run python tools/generate_service_design.py` で更新。

`POST /api/foods/custom` — 本人の独自食材を登録する
...
### `backend/src/app/apis/workspace/create_custom_food/sql/q019_private_release.sql`
...
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:395) / self.user_id (backend/src/app/core/workspace_service.py:402) / self.user_id (backend/src/app/core/workspace_service.py:410) |
...
### `backend/src/app/apis/workspace/create_custom_food/sql/q020_custom_food.sql`
...
| food_id | food_id (backend/src/app/core/workspace_service.py:402) / food_id (backend/src/app/core/workspace_service.py:410) / food_id (backend/src/app/core/workspace_service.py:411) |
| name | r['name'] (backend/src/app/core/workspace_service.py:137) / food.name.strip() (backend/src/app/core/workspace_service.py:402) |
| release_id | release_id (backend/src/app/core/workspace_service.py:395) / release_id (backend/src/app/core/workspace_service.py:402) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:395) / self.user_id (backend/src/app/core/workspace_service.py:402) / self.user_id (backend/src/app/core/workspace_service.py:410) |
...
### `backend/src/app/apis/workspace/create_custom_food/sql/q021_custom_owner.sql`
...
|---|---|
| food_id | food_id (backend/src/app/core/workspace_service.py:402) / food_id (backend/src/app/core/workspace_service.py:410) / food_id (backend/src/app/core/workspace_service.py:411) |
| row_id | uuid4() (backend/src/app/core/workspace_service.py:71) / uuid4() (backend/src/app/core/workspace_service.py:410) / uuid5(food_id, 'standard') (backend/src/app/core/workspace_service.py:411) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:395) / self.user_id (backend/src/app/core/workspace_service.py:402) / self.user_id (backend/src/app/core/workspace_service.py:410) |
...
### `backend/src/app/apis/workspace/create_custom_food/sql/q022_custom_form.sql`
...
| food_id | food_id (backend/src/app/core/workspace_service.py:402) / food_id (backend/src/app/core/workspace_service.py:410) / food_id (backend/src/app/core/workspace_service.py:411) |
| row_id | uuid4() (backend/src/app/core/workspace_service.py:71) / uuid4() (backend/src/app/core/workspace_service.py:410) / uuid5(food_id, 'standard') (backend/src/app/core/workspace_service.py:411) |
| unit | unit (backend/src/app/core/workspace_service.py:42) / food.default_unit (backend/src/app/core/workspace_service.py:411) |

### `backend/src/app/apis/workspace/create_custom_food/sql/q900_lock_revision.sql`
...
### `backend/src/app/apis/workspace/create_custom_food/sql/q901_advance_revision.sql`
...
### `backend/src/app/apis/workspace/create_custom_food/sql/q902_append_audit.sql`
...
| 関数 | 返却式 | 定義元 |
|---|---|---|
| handle | execute(WorkspaceService(database, identity), request) | backend/src/app/apis/workspace/create_custom_food/router.py:22 |
| execute | service.create_custom_food(request) | backend/src/app/apis/workspace/create_custom_food/functions.py:6 |
...
| WorkspaceService.create_custom_food | self.finish(q) | backend/src/app/core/workspace_service.py:419 |
...
| 関数 | 処理 | 定義元 |
|---|---|---|
| handle | 本人の独自食材を登録する。呼出元が送った利用者IDは使用しない。 | backend/src/app/apis/workspace/create_custom_food/router.py:22 |
| execute | 本人の独自食材を登録する。永続値は業務サービスが検証し、同一トランザクションで扱う。 | backend/src/app/apis/workspace/create_custom_food/functions.py:6 |
...
| WorkspaceService.create_custom_food | カタログにない食材を本人の所有として登録する。 | backend/src/app/core/workspace_service.py:419 |
