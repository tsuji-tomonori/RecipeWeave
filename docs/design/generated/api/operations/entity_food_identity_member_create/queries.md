# SQL仕様: entity_food_identity_member_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.food_identity_member | C | created_at, food_id, id, identity_id, normalizer_version, reason, xmin |

バインド変数: food_id, identity_id, normalizer_version, reason, row_id
