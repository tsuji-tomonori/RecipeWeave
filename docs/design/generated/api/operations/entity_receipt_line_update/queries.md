# SQL仕様: entity_receipt_line_update
...
| recipeweave.receipt_line | U | amount, created_at, decision, form_id, id, import_id, line_no, pantry_lot_id, product_version_id, raw_name, unit_id, xmin |

バインド変数: actor_id, amount, decision, expected_etag, form_id, import_id, line_no, pantry_lot_id, product_version_id, raw_name, row_id, unit_id
