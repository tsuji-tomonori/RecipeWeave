# SQL仕様: entity_source_record_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.source_record | U | content_hash, created_at, id, license_note, locator, retrieved_at, title, url, xmin |

バインド変数: content_hash, expected_etag, license_note, locator, retrieved_at, row_id, title, url
