# SQL仕様: entity_recipe_option_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_option | U | created_at, id, option_id, recipe_version_id, xmin |

バインド変数: expected_etag, option_id, recipe_version_id, row_id
