# SQL仕様: entity_step_dependency_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.step_dependency | U | after_step_id, before_step_id, created_at, id, kind, max_lag_s, min_lag_s, xmin |

バインド変数: after_step_id, before_step_id, expected_etag, kind, max_lag_s, min_lag_s, row_id
