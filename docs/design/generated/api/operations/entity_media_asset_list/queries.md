...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.media_asset | R | created_at, id, locale, media_type, operation_id, parameter_contract, sha256, source_id, uri, validation, version, xmin |
