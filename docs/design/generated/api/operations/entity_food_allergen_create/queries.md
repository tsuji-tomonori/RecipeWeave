# SQL仕様: entity_food_allergen_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.food_allergen | C | allergen_id, created_at, form_id, id, presence, source_id, xmin |

バインド変数: allergen_id, form_id, presence, row_id, source_id
