# SQL仕様: entity_generation_template_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_template | R | candidate_count, code, contract, contract_hash, created_at, id, release_id, version, xmin |
