...
| SQLバインド | 実装上の値の出所 |
|---|---|
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:365) / self.user_id (backend/src/app/core/workspace_service.py:371) |
...
| SQLバインド | 実装上の値の出所 |
|---|---|
| amount | item.quantity.value (backend/src/app/core/workspace_service.py:371) |
| archived | r['archived'] (backend/src/app/core/workspace_service.py:156) / item.archived (backend/src/app/core/workspace_service.py:371) |
| checked_at | checked_at (backend/src/app/core/workspace_service.py:371) |
| food_id | identifier(item.food_id) (backend/src/app/core/workspace_service.py:371) |
| key | r['client_key'] (backend/src/app/core/workspace_service.py:151) / item.key (backend/src/app/core/workspace_service.py:371) |
| row_id | uuid4() (backend/src/app/core/workspace_service.py:71) / uuid4() (backend/src/app/core/workspace_service.py:371) |
| signature | r['signature'] (backend/src/app/core/workspace_service.py:152) / item.signature (backend/src/app/core/workspace_service.py:371) |
| unit | unit (backend/src/app/core/workspace_service.py:42) / item.quantity.unit (backend/src/app/core/workspace_service.py:371) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:365) / self.user_id (backend/src/app/core/workspace_service.py:371) |
...
| not q.run('q002_insert', row_id=uuid4(), user_id=self.user_id, key=item.key, signature=item.signature, food_id=identifier(item.food_id), amount=item.quantity.value, unit=item.quantity.unit, checked_at=checked_at, archived=item.archived) | HTTPException(422, '買い物の単位が見つかりません') | backend/src/app/core/workspace_service.py:362 |
...
| WorkspaceService.put_shopping_checks | self.finish(q) | backend/src/app/core/workspace_service.py:362 |
...
| WorkspaceService.put_shopping_checks | 買い物確認を数量・単位とともに保存する。 | backend/src/app/core/workspace_service.py:362 |
