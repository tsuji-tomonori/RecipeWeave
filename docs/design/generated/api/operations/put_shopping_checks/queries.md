...
| recipeweave.user_shopping_check | C | amount, archived, checked_at, food_id, id, key, signature, unit_id, user_id |

バインド変数: amount, archived, checked_at, food_id, key, row_id, signature, unit, user_id
