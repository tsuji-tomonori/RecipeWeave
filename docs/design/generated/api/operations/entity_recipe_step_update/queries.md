# SQL仕様: entity_recipe_step_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_step | U | attention, completion_cue, created_at, duration_max_s, duration_min_s, id, instruction, operation_id, recipe_version_id, scaling_rule_id, step_no, title, xmin |

バインド変数: attention, completion_cue, duration_max_s, duration_min_s, expected_etag, instruction, operation_id, recipe_version_id, row_id, scaling_rule_id, step_no, title
