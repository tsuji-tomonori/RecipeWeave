...
| operation_id | CONTRACT.operation_id (backend/src/app/apis/entities/recipe_step_update/router.py:17) / spec.operation_id (backend/src/app/core/entity_service.py:49) / spec.operation_id (backend/src/app/core/entity_service.py:108) / spec.operation_id (backend/src/app/core/entity_service.py:118) |
| recipe_version_id | 検証済みリクエストモデル → payload → values → params。共有サービスがJSONB/整数列を変換する。 |
| row_id | row_id (backend/src/app/apis/entities/recipe_step_update/functions.py:13) / row_id or uuid4() (backend/src/app/core/entity_service.py:65) / uuid4() (backend/src/app/core/entity_service.py:139) / uuid4() (backend/src/app/core/entity_service.py:148) / uuid4() (backend/src/app/core/entity_service.py:154) |
