...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.axis | U | code, created_at, id, name, purpose, release_id, selection, status, xmin |

バインド変数: code, expected_etag, name, purpose, release_id, row_id, selection, status
