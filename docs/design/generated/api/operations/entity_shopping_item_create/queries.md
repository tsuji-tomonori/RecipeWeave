# SQL仕様: entity_shopping_item_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.shopping_item | C | archived, checked, checked_at, client_key, created_at, id, net_shortage, package_count, product_version_id, session_id, surplus_amount, total_id, xmin |

バインド変数: archived, checked, checked_at, client_key, net_shortage, package_count, product_version_id, row_id, session_id, surplus_amount, total_id
