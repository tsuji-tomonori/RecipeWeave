...
| SQLバインド | 実装上の値の出所 |
|---|---|
| row_id | uuid4() (backend/src/app/core/workspace_service.py:71) / row_id (backend/src/app/core/workspace_service.py:479) / row_id (backend/src/app/core/workspace_service.py:482) / row_id (backend/src/app/core/workspace_service.py:483) |
| user_id | self.user_id (backend/src/app/core/workspace_service.py:64) / self.user_id (backend/src/app/core/workspace_service.py:70) / self.user_id (backend/src/app/core/workspace_service.py:71) / self.user_id (backend/src/app/core/workspace_service.py:83) / self.user_id (backend/src/app/core/workspace_service.py:84) / self.user_id (backend/src/app/core/workspace_service.py:132) / self.user_id (backend/src/app/core/workspace_service.py:105) / self.user_id (backend/src/app/core/workspace_service.py:119) / self.user_id (backend/src/app/core/workspace_service.py:147) / self.user_id (backend/src/app/core/workspace_service.py:158) / self.user_id (backend/src/app/core/workspace_service.py:171) / self.user_id (backend/src/app/core/workspace_service.py:187) / self.user_id (backend/src/app/core/workspace_service.py:205) / self.user_id (backend/src/app/core/workspace_service.py:479) / self.user_id (backend/src/app/core/workspace_service.py:482) / self.user_id (backend/src/app/core/workspace_service.py:483) |
...
| not rows or rows[0]['status'] != 'committed' | HTTPException(409, 'レシートがないか取消済みです') | backend/src/app/core/workspace_service.py:476 |
...
| WorkspaceService.undo_receipt | self.finish(q) | backend/src/app/core/workspace_service.py:476 |
...
| WorkspaceService.undo_receipt | 未使用・未編集の登録分だけを取り消し、使用済みの在庫は残す。 | backend/src/app/core/workspace_service.py:476 |
