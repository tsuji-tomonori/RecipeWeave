...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.receipt_import | R | id, status, user_id |
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.pantry_consumption | R | lot_id |
| recipeweave.pantry_lot | U | edited, id, source_import_id, status, updated_at, user_id |
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.receipt_import | U | id, reverted_at, revision, status, user_id |
