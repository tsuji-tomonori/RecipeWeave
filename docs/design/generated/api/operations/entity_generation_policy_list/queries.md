# SQL仕様: entity_generation_policy_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_policy | R | created_at, id, model_identifier, parameter_json, prompt_template, release_id, schema_version, version, xmin |
