# SQL仕様: entity_generation_job_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_job | R | attempt_count, created_at, error_code, finished_at, id, idempotency_key, policy_id, seed, started_at, status, xmin |
