# SQL仕様: entity_conversion_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.conversion | U | conditions, created_at, factor, form_id, from_unit_id, id, quality, release_id, source_id, to_unit_id, xmin |

バインド変数: conditions, expected_etag, factor, form_id, from_unit_id, quality, release_id, row_id, source_id, to_unit_id
