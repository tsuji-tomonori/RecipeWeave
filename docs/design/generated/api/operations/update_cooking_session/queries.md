...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.cooking_session | R | created_at, current_task_index, id, menu_id, status |
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.cooking_session | U | current_task_index, id, menu_id, status |
| recipeweave.menu | R | id, user_id |

バインド変数: index, session_id, status, user_id
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.session_task | U | actual_end_at, actual_start_at, id, session_id, status |

バインド変数: row_id, session_id
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.session_task | U | id, planned_end_s, planned_start_s, session_id, timer_duration_s, timer_started_at |
...
| recipeweave.ingredient_total | R | form_id, id, product_version_id, required_amount, session_id, unit_id |
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.pantry_lot | R | amount, created_at, expires_on, form_id, id, product_version_id, quantity_quality, status, unit_id, user_id |

バインド変数: form_id, product_id, unit_id, user_id
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.pantry_lot | U | amount, id, updated_at, user_id |

バインド変数: amount, lot_id, user_id
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.pantry_consumption | C | amount, id, lot_id, session_id, unit_id, user_id |

バインド変数: amount, lot_id, row_id, session_id, unit_id, user_id
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.ingredient_total | U | actual_amount, consumption_outcome, id, session_id |

バインド変数: amount, outcome, session_id, total_id
