# SQL仕様: entity_operation_parameter_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.operation_parameter | R | allowed_values, code, created_at, id, max_value, min_value, name, operation_id, required, unit_id, value_type, xmin |
