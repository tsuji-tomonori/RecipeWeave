...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.conversion | R | conditions, created_at, factor, form_id, from_unit_id, id, quality, release_id, source_id, to_unit_id, xmin |
