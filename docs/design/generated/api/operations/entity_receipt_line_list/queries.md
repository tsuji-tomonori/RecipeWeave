# SQL仕様: entity_receipt_line_list
...
| recipeweave.receipt_line | R | amount, created_at, decision, form_id, id, import_id, line_no, pantry_lot_id, product_version_id, raw_name, unit_id, xmin |
