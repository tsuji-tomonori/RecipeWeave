# SQL仕様: entity_validation_result_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.validation_result | R | created_at, evaluated_at, evidence, id, recipe_version_id, rule_id, state, validator_version, xmin |
