# SQL仕様: entity_source_record_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.source_record | C | content_hash, created_at, id, license_note, locator, retrieved_at, title, url, xmin |

バインド変数: content_hash, license_note, locator, retrieved_at, row_id, title, url
