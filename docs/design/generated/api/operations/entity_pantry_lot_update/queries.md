# SQL仕様: entity_pantry_lot_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.pantry_lot | U | amount, created_at, edited, expires_on, form_id, id, location, opened_at, original_amount, original_form_id, original_unit_id, priority, product_version_id, quantity_quality, source_import_id, status, unit_id, updated_at, user_id, xmin |

バインド変数: actor_id, amount, edited, expected_etag, expires_on, form_id, location, opened_at, original_amount, original_form_id, original_unit_id, priority, product_version_id, quantity_quality, row_id, source_import_id, status, unit_id, updated_at, user_id
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.app_user | R | id |

バインド変数: actor_id, reference_id
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.workspace_revision | C,U | revision, user_id |
