# インターフェース: entity_food_identity_member_get
...
"""購買食品から同一性への対応の取得。具体例は専用型と操作別受入テストに対応する。"""
...
```json
{
  "description": "購買食品から同一性への対応の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。",
  "operationId": "entity_food_identity_member_get",
  "parameters": [
    {
      "in": "path",
      "name": "row_id",
