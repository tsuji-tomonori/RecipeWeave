# SQL仕様: entity_operation_parameter_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.operation_parameter | U | allowed_values, code, created_at, id, max_value, min_value, name, operation_id, required, unit_id, value_type, xmin |

バインド変数: allowed_values, code, expected_etag, max_value, min_value, name, operation_id, required, row_id, unit_id, value_type
