...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.food_form | C | base_unit_id, created_at, food_id, id, name, quantity_basis, state, status, xmin |

バインド変数: base_unit_id, food_id, name, quantity_basis, row_id, state, status
