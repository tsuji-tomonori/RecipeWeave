# SQL仕様: entity_generation_shard_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_shard | C | created_at, end_ordinal, fence_token, id, lease_expires_at, lease_owner, next_ordinal, start_ordinal, state, template_id, xmin |

バインド変数: end_ordinal, fence_token, lease_expires_at, lease_owner, next_ordinal, row_id, start_ordinal, state, template_id
