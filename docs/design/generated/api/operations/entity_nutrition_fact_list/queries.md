# SQL仕様: entity_nutrition_fact_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.nutrition_fact | R | amount, basis_amount, basis_unit_id, created_at, form_id, id, nutrient_id, product_version_id, source_id, xmin |
