# SQL仕様: entity_shopping_item_update
...
| recipeweave.shopping_item | U | archived, checked, checked_at, client_key, created_at, id, net_shortage, package_count, product_version_id, session_id, surplus_amount, total_id, xmin |

バインド変数: actor_id, archived, checked, checked_at, client_key, expected_etag, net_shortage, package_count, product_version_id, row_id, session_id, surplus_amount, total_id
...
|---|---|---|
| recipeweave.cooking_session | R | id, menu_id |
| recipeweave.ingredient_total | R | id, session_id |
| recipeweave.menu | R | id, user_id |
