# SQL仕様: entity_product_allergen_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.product_allergen | C | allergen_id, created_at, id, presence, product_version_id, source_id, xmin |

バインド変数: allergen_id, presence, product_version_id, row_id, source_id
