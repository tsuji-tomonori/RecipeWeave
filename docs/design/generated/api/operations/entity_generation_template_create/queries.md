# SQL仕様: entity_generation_template_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_template | C | candidate_count, code, contract, contract_hash, created_at, id, release_id, version, xmin |

バインド変数: candidate_count, code, contract, contract_hash, release_id, row_id, version
