...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.app_user | U | auth_subject, created_at, id, locale, state, timezone, xmin |

バインド変数: actor_id, expected_etag, locale, row_id, timezone
