...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.product | U | brand, created_at, food_id, gtin, id, name, status, xmin |

バインド変数: brand, expected_etag, food_id, gtin, name, row_id, status
