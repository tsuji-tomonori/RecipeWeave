# SQL仕様: entity_kitchen_resource_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.kitchen_resource | U | active, capacity, created_at, id, name, quantity, resource_type_id, user_id, xmin |

バインド変数: active, actor_id, capacity, expected_etag, name, quantity, resource_type_id, row_id, user_id
