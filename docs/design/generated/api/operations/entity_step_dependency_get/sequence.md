# シーケンス: entity_step_dependency_get
...
定義元: `backend/src/app/apis/entities/step_dependency_get/router.py:31`
...
定義元: `backend/src/app/apis/entities/step_dependency_get/functions.py:9`
...
sequenceDiagram
    ...
    Function->>Callee: service.execute(SPECIFICATIONS[#39;entity_step_dependency_get#39;], row_id=row_id)
    Callee-->>Function: 呼出結果（例外は呼出元へ伝播）
    Note over Function: rows = service.execute(SPECIFICATIONS[#39;entity_step_dependency_get#39;], row_id=row_id)
