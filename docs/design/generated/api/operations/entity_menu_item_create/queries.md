...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.menu_item | C | created_at, id, menu_id, position, recipe_version_id, role_option_id, servings, xmin |

バインド変数: menu_id, position, recipe_version_id, role_option_id, row_id, servings
