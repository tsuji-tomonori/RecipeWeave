# SQL仕様: entity_food_identity_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.food_identity | C | code, created_at, id, name, normalizer_version, xmin |

バインド変数: code, name, normalizer_version, row_id
