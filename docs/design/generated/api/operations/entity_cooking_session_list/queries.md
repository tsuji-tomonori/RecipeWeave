# SQL仕様: entity_cooking_session_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.cooking_session | R | created_at, current_task_index, id, input_hash, input_snapshot, menu_id, menu_revision, planner_version, status, target_at, xmin |
