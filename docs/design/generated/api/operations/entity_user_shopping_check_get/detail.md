# 詳細設計: entity_user_shopping_check_get
...
### `backend/src/app/apis/entities/user_shopping_check_get/sql/001_get.sql`
...
| row_id | row_id (backend/src/app/apis/entities/user_shopping_check_get/functions.py:11) / row_id or uuid4() (backend/src/app/core/entity_service.py:65) / uuid4() (backend/src/app/core/entity_service.py:139) / uuid4() (backend/src/app/core/entity_service.py:148) / uuid4() (backend/src/app/core/entity_service.py:154) |

代入・選択式: `t.id; t.created_at; t.user_id; t.key; t.signature; t.food_id; t.amount; t.unit_id; t.checked_at; t.archived; CAST(t.xmin AS TEXT) AS etag`
...
| 関数 | 返却式 | 定義元 |
|---|---|---|
| handle | result | backend/src/app/apis/entities/user_shopping_check_get/router.py:31 |
| execute | UserShoppingCheckRow.model_validate(rows[0]) | backend/src/app/apis/entities/user_shopping_check_get/functions.py:9 |
...
| 関数 | 処理 | 定義元 |
|---|---|---|
| handle | 調理前の買い物確認の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。 | backend/src/app/apis/entities/user_shopping_check_get/router.py:31 |
| execute | 調理前の買い物確認の取得を固定操作契約で実行し、DB行を専用応答型へ検証する。 | backend/src/app/apis/entities/user_shopping_check_get/functions.py:9 |
