# SQL仕様: entity_generation_job_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_job | U | attempt_count, created_at, error_code, finished_at, id, idempotency_key, policy_id, seed, started_at, status, xmin |

バインド変数: attempt_count, error_code, expected_etag, finished_at, idempotency_key, policy_id, row_id, seed, started_at, status
