...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.food | C | code, created_at, id, kind, name, owner_id, parent_id, release_id, status, xmin |

バインド変数: code, kind, name, parent_id, release_id, row_id, status
