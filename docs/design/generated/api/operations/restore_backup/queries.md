...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.backup_restore_intent | R | artifact_id, body_sha256, consumed_at, current_revision, expires_at, id, user_id |
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.backup_restore_intent | U | body_sha256, consumed_at, current_revision, expires_at, id, user_id |

バインド変数: actor_id, body_sha256, current_revision, intent_id
...
バインド変数: actor_id, key_hash, row_id
...
バインド変数: actor_id, event_id, version
