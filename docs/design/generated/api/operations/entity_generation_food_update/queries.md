# SQL仕様: entity_generation_food_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_food | U | created_at, form_id, id, job_id, role, xmin |

バインド変数: expected_etag, form_id, job_id, role, row_id
