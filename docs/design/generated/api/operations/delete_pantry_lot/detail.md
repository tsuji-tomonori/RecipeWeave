...
| not q.run('q001_delete_lot', row_id=row_id, user_id=self.user_id) | HTTPException(404, '在庫が見つからないか削除済みです') | backend/src/app/core/workspace_service.py:256 |
...
| WorkspaceService.delete_pantry_lot | self.finish(q) | backend/src/app/core/workspace_service.py:256 |
...
| WorkspaceService.delete_pantry_lot | 消費履歴を残し、在庫を利用対象から外す。 | backend/src/app/core/workspace_service.py:256 |
