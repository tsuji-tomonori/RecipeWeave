# SQL仕様: entity_recipe_similarity_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_similarity | U | algorithm_version, created_at, explanation, id, left_version_id, right_version_id, score, xmin |

バインド変数: algorithm_version, expected_etag, explanation, left_version_id, right_version_id, row_id, score
