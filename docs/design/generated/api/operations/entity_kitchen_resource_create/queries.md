# SQL仕様: entity_kitchen_resource_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.kitchen_resource | C | active, capacity, created_at, id, name, quantity, resource_type_id, user_id, xmin |

バインド変数: active, capacity, name, quantity, resource_type_id, row_id, user_id
