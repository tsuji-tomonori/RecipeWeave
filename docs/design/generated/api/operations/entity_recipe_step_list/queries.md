...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_step | R | attention, completion_cue, created_at, duration_max_s, duration_min_s, id, instruction, operation_id, recipe_version_id, scaling_rule_id, step_no, title, xmin |
