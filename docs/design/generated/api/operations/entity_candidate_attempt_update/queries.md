# SQL仕様: entity_candidate_attempt_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.candidate_attempt | U | attempts, created_at, design_key, id, job_id, ordinal, reason_code, recipe_version_id, state, template_id, xmin |

バインド変数: attempts, design_key, expected_etag, job_id, ordinal, reason_code, recipe_version_id, row_id, state, template_id
