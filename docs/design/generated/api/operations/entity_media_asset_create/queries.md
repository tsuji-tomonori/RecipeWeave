# SQL仕様: entity_media_asset_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.media_asset | C | created_at, id, locale, media_type, operation_id, parameter_contract, sha256, source_id, uri, validation, version, xmin |

バインド変数: locale, media_type, operation_id, parameter_contract, row_id, sha256, source_id, uri, validation, version
