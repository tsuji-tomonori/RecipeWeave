# SQL仕様: entity_step_media_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.step_media | C | created_at, end_ms, id, media_id, start_ms, step_id, xmin |

バインド変数: end_ms, media_id, row_id, start_ms, step_id
