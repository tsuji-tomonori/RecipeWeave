# SQL仕様: entity_nutrition_fact_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.nutrition_fact | C | amount, basis_amount, basis_unit_id, created_at, form_id, id, nutrient_id, product_version_id, source_id, xmin |

バインド変数: amount, basis_amount, basis_unit_id, form_id, nutrient_id, product_version_id, row_id, source_id
