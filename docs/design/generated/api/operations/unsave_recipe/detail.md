...
| WorkspaceService.unsave_recipe | self._save_recipe('unsave_recipe', request, row_id) | backend/src/app/core/workspace_service.py:345 |
...
| WorkspaceService.unsave_recipe | 保存の解除を本人の履歴へ追記する。 | backend/src/app/core/workspace_service.py:345 |
