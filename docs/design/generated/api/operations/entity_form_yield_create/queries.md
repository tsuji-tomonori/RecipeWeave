# SQL仕様: entity_form_yield_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.form_yield | C | conditions, created_at, id, input_form_id, output_form_id, quality, source_id, xmin, yield_ratio |

バインド変数: conditions, input_form_id, output_form_id, quality, row_id, source_id, yield_ratio
