# SQL仕様: entity_recipe_similarity_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_similarity | C | algorithm_version, created_at, explanation, id, left_version_id, right_version_id, score, xmin |

バインド変数: algorithm_version, explanation, left_version_id, right_version_id, row_id, score
