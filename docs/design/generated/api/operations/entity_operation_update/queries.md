...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.operation | U | code, completion_cue, created_at, definition, id, name, precondition, status, xmin |

バインド変数: code, completion_cue, definition, expected_etag, name, precondition, row_id, status
