# SQL仕様: entity_pantry_lot_delete
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.pantry_lot | D | amount, created_at, edited, expires_on, form_id, id, location, opened_at, original_amount, original_form_id, original_unit_id, priority, product_version_id, quantity_quality, source_import_id, status, unit_id, updated_at, user_id, xmin |
