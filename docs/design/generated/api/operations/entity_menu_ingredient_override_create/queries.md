# SQL仕様: entity_menu_ingredient_override_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.menu_ingredient_override | C | amount, created_at, form_id, id, ingredient_line_id, menu_item_id, product_version_id, selected, xmin |

バインド変数: amount, form_id, ingredient_line_id, menu_item_id, product_version_id, row_id, selected
