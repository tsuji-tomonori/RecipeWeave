# SQL仕様: entity_axis_option_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.axis_option | U | axis_id, code, created_at, definition, id, label, parent_id, status, xmin |

バインド変数: axis_id, code, definition, expected_etag, label, parent_id, row_id, status
