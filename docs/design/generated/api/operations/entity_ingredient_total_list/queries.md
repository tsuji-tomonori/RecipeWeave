# SQL仕様: entity_ingredient_total_list
...
| recipeweave.ingredient_total | R | actual_amount, calculation_version, consumption_outcome, created_at, form_id, id, product_version_id, quality, required_amount, session_id, unit_id, xmin |
