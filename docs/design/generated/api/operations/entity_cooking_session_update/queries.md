# SQL仕様: entity_cooking_session_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.cooking_session | U | created_at, current_task_index, id, input_hash, input_snapshot, menu_id, menu_revision, planner_version, status, target_at, xmin |
| recipeweave.menu | R | id, user_id |

バインド変数: actor_id, current_task_index, expected_etag, input_hash, input_snapshot, menu_id, menu_revision, planner_version, row_id, status, target_at
