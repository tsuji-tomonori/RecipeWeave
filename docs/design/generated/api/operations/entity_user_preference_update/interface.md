# インターフェース: entity_user_preference_update
...
"""ユーザーの嗜好の更新。具体例は専用型と操作別受入テストに対応する。"""
...
```json
{
  "description": "ユーザーの嗜好の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。",
  "operationId": "entity_user_preference_update",
  "parameters": [
    {
      "in": "path",
      "name": "row_id",
  ...
  "requestBody": {
    "content": {
      "application/json": {
        "schema": {
          "$ref": "#/components/schemas/UserPreferenceWrite"
        }
      }
    },
    "required": true
