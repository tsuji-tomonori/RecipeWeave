# SQL仕様: entity_user_preference_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.user_preference | U | created_at, id, option_id, user_id, weight, xmin |

バインド変数: actor_id, expected_etag, option_id, row_id, user_id, weight
