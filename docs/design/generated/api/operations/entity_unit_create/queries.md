...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.unit | C | code, created_at, dimension, factor, id, name, offset, status, xmin |

バインド変数: code, dimension, factor, name, offset, row_id, status
