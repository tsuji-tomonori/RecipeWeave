...
| 入力場所 | 名前 | 型 | 必須 |
|---|---|---|---|
| path | recipe_id | string (uuid) | True |
| query | preview | boolean | False |
| query | versionId | anyOf(string (uuid), null) | False |
...
| limit | 1 (backend/src/app/apis/recipes/get_recipe/functions.py:15) / limit (backend/src/app/integrations/catalog/postgres_provider.py:48) |
...
| owner_id | owner_id (backend/src/app/apis/recipes/get_recipe/functions.py:15) / owner_id (backend/src/app/integrations/catalog/postgres_provider.py:62) |
| preview | preview (backend/src/app/apis/recipes/get_recipe/functions.py:15) / preview (backend/src/app/integrations/catalog/postgres_provider.py:48) |
| q | query (backend/src/app/integrations/catalog/postgres_provider.py:48) |
| recipe_id | recipe_id (backend/src/app/apis/recipes/get_recipe/functions.py:15) / recipe_id (backend/src/app/integrations/catalog/postgres_provider.py:48) |
| selected_food_ids | selected_food_ids or [] (backend/src/app/integrations/catalog/postgres_provider.py:48) |
| version_id | version_id (backend/src/app/apis/recipes/get_recipe/functions.py:15) / version_id (backend/src/app/integrations/catalog/postgres_provider.py:62) |
...
| 判定条件 | 例外・応答 | 定義元 |
|---|---|---|
| recipe is None | HTTPException(status_code=404, detail='料理が見つかりません') | backend/src/app/apis/recipes/get_recipe/router.py:32 |

## 出力

| 関数 | 返却式 | 定義元 |
|---|---|---|
| get_recipe | recipe | backend/src/app/apis/recipes/get_recipe/router.py:32 |
| get_recipe | items[0] if items else None | backend/src/app/apis/recipes/get_recipe/functions.py:7 |
...
| 関数 | 処理 | 定義元 |
|---|---|---|
| get_recipe | 個別説明なし | backend/src/app/apis/recipes/get_recipe/router.py:32 |
| get_recipe | 実体テーブルに保存された版の材料・工程を取得する。 | backend/src/app/apis/recipes/get_recipe/functions.py:7 |
