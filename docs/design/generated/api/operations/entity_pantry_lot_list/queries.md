...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.pantry_lot | R | amount, created_at, edited, expires_on, form_id, id, location, opened_at, original_amount, original_form_id, original_unit_id, priority, product_version_id, quantity_quality, source_import_id, status, unit_id, updated_at, user_id, xmin |

バインド変数: actor_id, after_id, page_limit
