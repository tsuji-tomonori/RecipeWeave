# SQL仕様: entity_user_exclusion_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.user_exclusion | U | allergen_id, created_at, food_id, id, strict, user_id, xmin |

バインド変数: actor_id, allergen_id, expected_etag, food_id, row_id, strict, user_id
