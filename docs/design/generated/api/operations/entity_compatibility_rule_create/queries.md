# SQL仕様: entity_compatibility_rule_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.compatibility_rule | C | code, created_at, id, message, predicate, severity, source_id, status, version, xmin |

バインド変数: code, message, predicate, row_id, severity, source_id, status, version
