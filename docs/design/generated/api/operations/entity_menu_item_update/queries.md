...
| recipeweave.menu_item | U | created_at, id, menu_id, position, recipe_version_id, role_option_id, servings, xmin |

バインド変数: actor_id, expected_etag, menu_id, position, recipe_version_id, role_option_id, row_id, servings
