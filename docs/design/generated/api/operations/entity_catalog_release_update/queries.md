# SQL仕様: entity_catalog_release_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.catalog_release | U | created_at, id, manifest_hash, owner_id, published_at, version, xmin |

バインド変数: expected_etag, manifest_hash, published_at, row_id, version
