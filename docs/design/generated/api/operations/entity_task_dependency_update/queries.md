# SQL仕様: entity_task_dependency_update
...
| recipeweave.task_dependency | U | after_task_id, before_task_id, created_at, id, max_lag_s, min_lag_s, reason, xmin |

バインド変数: actor_id, after_task_id, before_task_id, expected_etag, max_lag_s, min_lag_s, reason, row_id
