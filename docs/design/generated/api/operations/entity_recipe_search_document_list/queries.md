# SQL仕様: entity_recipe_search_document_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_search_document | R | created_at, display_title, eligible, facet_option_ids, food_identity_ids, id, projected_at, projection_version, published_version_id, recipe_id, search_text, source_hash, xmin |
