# SQL仕様: entity_generation_stratum_metric_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.generation_stratum_metric | R | attempted, cost_amount, created_at, currency, id, input_tokens, output_tokens, publishable, stratum_key, template_id, unique_count, valid, window_end, window_start, xmin |
