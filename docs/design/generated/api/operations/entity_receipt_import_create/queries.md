# SQL仕様: entity_receipt_import_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.receipt_import | C | committed_at, created_at, file_sha256, id, idempotency_key, reverted_at, revision, status, undo_preserved_count, user_id, xmin |

バインド変数: committed_at, file_sha256, idempotency_key, reverted_at, revision, row_id, status, undo_preserved_count, user_id
