# SQL仕様: entity_user_shopping_check_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.user_shopping_check | C | amount, archived, checked_at, created_at, food_id, id, key, signature, unit_id, user_id, xmin |

バインド変数: amount, archived, checked_at, food_id, key, row_id, signature, unit_id, user_id
