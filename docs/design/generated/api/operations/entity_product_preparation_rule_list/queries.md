# SQL仕様: entity_product_preparation_rule_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.product_preparation_rule | R | allowed, created_at, id, operation_id, parameter_contract, product_version_id, source_id, use_original_container, xmin |
