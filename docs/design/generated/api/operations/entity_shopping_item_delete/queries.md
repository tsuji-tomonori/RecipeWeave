# SQL仕様: entity_shopping_item_delete
...
| recipeweave.shopping_item | D | archived, checked, checked_at, client_key, created_at, id, net_shortage, package_count, product_version_id, session_id, surplus_amount, total_id, xmin |
