# SQL仕様: entity_scaling_rule_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.scaling_rule | R | batch_capacity, created_at, id, max_servings, min_servings, mode, name, round_increment, round_mode, source_id, xmin |
