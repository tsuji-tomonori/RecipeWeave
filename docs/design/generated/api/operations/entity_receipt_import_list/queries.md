# SQL仕様: entity_receipt_import_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.receipt_import | R | committed_at, created_at, file_sha256, id, idempotency_key, reverted_at, revision, status, undo_preserved_count, user_id, xmin |
