# インターフェース: entity_user_shopping_check_delete
...
"""調理前の買い物確認の削除。具体例は専用型と操作別受入テストに対応する。"""
...
```json
{
  "description": "調理前の買い物確認の削除。認証情報は依存から取得し、本人所有または管理者権限を検査する。",
  "operationId": "entity_user_shopping_check_delete",
  "parameters": [
    {
      "in": "path",
      "name": "row_id",
