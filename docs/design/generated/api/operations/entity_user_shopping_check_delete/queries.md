# SQL仕様: entity_user_shopping_check_delete
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.user_shopping_check | D | amount, archived, checked_at, created_at, food_id, id, key, signature, unit_id, user_id, xmin |
