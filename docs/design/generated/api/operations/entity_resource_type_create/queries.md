# SQL仕様: entity_resource_type_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.resource_type | C | capacity_unit_id, code, created_at, id, name, status, xmin |

バインド変数: capacity_unit_id, code, name, row_id, status
