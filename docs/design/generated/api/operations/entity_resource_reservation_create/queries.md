# SQL仕様: entity_resource_reservation_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.resource_reservation | C | created_at, end_s, id, quantity, resource_id, start_s, task_id, xmin |

バインド変数: end_s, quantity, resource_id, row_id, start_s, task_id
