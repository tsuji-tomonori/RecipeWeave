# インターフェース: entity_step_resource_update
...
"""工程の資源要求の更新。具体例は専用型と操作別受入テストに対応する。"""
...
```json
{
  "description": "工程の資源要求の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。",
  "operationId": "entity_step_resource_update",
  "parameters": [
    {
      "in": "path",
      "name": "row_id",
