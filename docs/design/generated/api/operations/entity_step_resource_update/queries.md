# SQL仕様: entity_step_resource_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.step_resource | U | capacity_min, created_at, exclusive, id, quantity, resource_type_id, step_id, xmin |

バインド変数: capacity_min, exclusive, expected_etag, quantity, resource_type_id, row_id, step_id
