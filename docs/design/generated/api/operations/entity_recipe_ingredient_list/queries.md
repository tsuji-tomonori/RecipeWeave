# SQL仕様: entity_recipe_ingredient_list
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_ingredient | R | amount, amount_max, amount_mode, canonical_amount, component_id, conversion_id, created_at, demand_kind, form_id, id, kit_parent_line_id, line_no, note, optional, product_version_id, recipe_version_id, role, scaling_rule_id, unit_id, xmin |
