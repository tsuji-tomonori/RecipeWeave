# SQL仕様: entity_validation_result_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.validation_result | C | created_at, evaluated_at, evidence, id, recipe_version_id, rule_id, state, validator_version, xmin |

バインド変数: evaluated_at, evidence, recipe_version_id, row_id, rule_id, state, validator_version
