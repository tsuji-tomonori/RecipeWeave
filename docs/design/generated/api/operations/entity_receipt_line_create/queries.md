# SQL仕様: entity_receipt_line_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.receipt_line | C | amount, created_at, decision, form_id, id, import_id, line_no, pantry_lot_id, product_version_id, raw_name, unit_id, xmin |

バインド変数: amount, decision, form_id, import_id, line_no, pantry_lot_id, product_version_id, raw_name, row_id, unit_id
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.pantry_lot | R | id, user_id |
