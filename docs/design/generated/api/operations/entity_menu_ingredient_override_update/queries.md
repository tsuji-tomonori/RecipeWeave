# SQL仕様: entity_menu_ingredient_override_update
...
| recipeweave.menu_ingredient_override | U | amount, created_at, form_id, id, ingredient_line_id, menu_item_id, product_version_id, selected, xmin |
| recipeweave.menu_item | R | id, menu_id |

バインド変数: actor_id, amount, expected_etag, form_id, ingredient_line_id, menu_item_id, product_version_id, row_id, selected
