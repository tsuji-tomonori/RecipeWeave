# SQL仕様: entity_user_exclusion_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.user_exclusion | C | allergen_id, created_at, food_id, id, strict, user_id, xmin |

バインド変数: allergen_id, food_id, row_id, strict, user_id
