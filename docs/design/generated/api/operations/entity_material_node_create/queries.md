# SQL仕様: entity_material_node_create
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.material_node | C | amount, created_at, id, ingredient_line_id, kind, name, producer_step_id, recipe_version_id, unit_id, xmin |

バインド変数: amount, ingredient_line_id, kind, name, producer_step_id, recipe_version_id, row_id, unit_id
