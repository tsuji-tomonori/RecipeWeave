# SQL仕様: entity_recipe_version_update
...
| 対象表 | CRUD | 参照・書込列 |
|---|---|---|
| recipeweave.recipe_version | U | base_servings, content_hash, created_at, description, id, output_amount, output_unit_id, published_at, recipe_id, release_id, status, validation, version, xmin |

バインド変数: base_servings, content_hash, description, expected_etag, output_amount, output_unit_id, published_at, recipe_id, release_id, row_id, status, validation, version
