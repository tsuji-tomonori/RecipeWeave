...
export interface MealItem extends RecipeDraft {
  id: string;
}
...
export interface ShoppingRow {
  ...
  available: Quantity;
  toBuy: Quantity;
  status: "enough" | "buy" | "unknown" | "incompatible";
  reason: string;
  checked: boolean;
}
