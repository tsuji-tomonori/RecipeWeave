...
| 関数 | 責務 | 定義元 |
|---|---|---|
| get_state | 個別の説明なし。下記の実装を参照。 | backend/src/app/apis/state/get_state/router.py:21 |
| get_state | 認証済み本人の状態だけを読む。呼出側が他の利用者識別子を選ぶことはできない。 | backend/src/app/apis/state/get_state/functions.py:5 |
...
[インターフェース](/RecipeWeave/quality/design/api/operations/get_state/interface/) / [シーケンス](/RecipeWeave/quality/design/api/operations/get_state/sequence/) / [SQL](/RecipeWeave/quality/design/api/operations/get_state/queries/) / [検証](/RecipeWeave/quality/design/api/operations/get_state/tests/)
