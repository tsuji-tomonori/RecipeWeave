...
| 関数 | 責務 | 定義元 |
|---|---|---|
| put_state | 個別の説明なし。下記の実装を参照。 | backend/src/app/apis/state/put_state/router.py:23 |
| put_state | 条件付きで保存する。競合時に新しい端末データを黙って上書きしない。 | backend/src/app/apis/state/put_state/functions.py:5 |
...
[インターフェース](/RecipeWeave/quality/design/api/operations/put_state/interface/) / [シーケンス](/RecipeWeave/quality/design/api/operations/put_state/sequence/) / [SQL](/RecipeWeave/quality/design/api/operations/put_state/queries/) / [検証](/RecipeWeave/quality/design/api/operations/put_state/tests/)
