...
| 関数 | 責務 | 定義元 |
|---|---|---|
| list_foods | 個別の説明なし。下記の実装を参照。 | backend/src/app/apis/foods/list_foods/router.py:15 |
| list_foods | 正規化した検索語に一致するサンプル食材名と別名を返す。 | backend/src/app/apis/foods/list_foods/functions.py:8 |
...
[インターフェース](/RecipeWeave/quality/design/api/operations/list_foods/interface/) / [シーケンス](/RecipeWeave/quality/design/api/operations/list_foods/sequence/) / [SQL](/RecipeWeave/quality/design/api/operations/list_foods/queries/) / [検証](/RecipeWeave/quality/design/api/operations/list_foods/tests/)
