...
# Retrospective integrity pins for the already-recorded confirmation run.  These
# hashes establish which artifacts this report accepts; they are not evidence
# that the design was preregistered before judging.
