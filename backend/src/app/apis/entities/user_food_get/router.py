...
from app.apis.entities.user_food_get.contract import CONTRACT
from app.apis.entities.user_food_get.functions import execute
from app.apis.entities.user_food_get.schemas import UserFoodRow
...
def handle(
    ...
    """利用者が追加した独自食材の所有の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
