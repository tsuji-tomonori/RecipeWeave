...
from app.apis.entities.scaling_point_get.contract import CONTRACT
from app.apis.entities.scaling_point_get.functions import execute
from app.apis.entities.scaling_point_get.schemas import ScalingPointRow
...
def handle(
    ...
    """検証済み換算点の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
