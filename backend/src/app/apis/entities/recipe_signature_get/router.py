...
from app.apis.entities.recipe_signature_get.contract import CONTRACT
from app.apis.entities.recipe_signature_get.functions import execute
from app.apis.entities.recipe_signature_get.schemas import RecipeSignatureRow
...
def handle(
    ...
    """内容重複判定署名の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
