...
from app.apis.entities.food_create.contract import CONTRACT
from app.apis.entities.food_create.functions import execute
from app.apis.entities.food_create.schemas import FoodRow, FoodWrite
from app.core.db import DatabaseDependency
from app.core.entity_service import EntityService
from app.core.identity import IdentityDependency

router = APIRouter(tags=["正規化データ: 購入・利用食材概念"])
...
def handle(
    ...
    """購入・利用食材概念の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
