...
from app.apis.entities.food_identity_get.contract import CONTRACT
from app.apis.entities.food_identity_get.functions import execute
from app.apis.entities.food_identity_get.schemas import FoodIdentityRow
...
def handle(
    ...
    """料理同一性上の食品の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
