...
from app.apis.entities.resource_type_update.contract import CONTRACT
from app.apis.entities.resource_type_update.functions import execute
from app.apis.entities.resource_type_update.schemas import ResourceTypeRow, ResourceTypeWrite
...
def handle(
    ...
    """道具・設備・作業者種別の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
