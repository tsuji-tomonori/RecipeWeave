...
from app.apis.entities.catalog_release_get.contract import CONTRACT
from app.apis.entities.catalog_release_get.functions import execute
from app.apis.entities.catalog_release_get.schemas import CatalogReleaseRow
...
def handle(
    ...
    """カタログ公開版の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
