...
from app.apis.entities.pantry_lot_get.contract import CONTRACT
from app.apis.entities.pantry_lot_get.functions import execute
from app.apis.entities.pantry_lot_get.schemas import PantryLotRow
...
def handle(
    ...
    """手持ち食材ロットの取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
