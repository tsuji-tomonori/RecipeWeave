...
from app.apis.entities.generation_shard_create.contract import CONTRACT
from app.apis.entities.generation_shard_create.functions import execute
from app.apis.entities.generation_shard_create.schemas import (
    GenerationShardRow,
...
def handle(
    ...
    payload: GenerationShardWrite,
) -> GenerationShardRow:
    """列挙範囲・リース管理の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
