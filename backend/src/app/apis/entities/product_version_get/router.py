...
from app.apis.entities.product_version_get.contract import CONTRACT
from app.apis.entities.product_version_get.functions import execute
from app.apis.entities.product_version_get.schemas import ProductVersionRow
...
def handle(
    ...
    """商品仕様版の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
