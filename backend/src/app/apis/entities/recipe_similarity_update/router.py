...
from app.apis.entities.recipe_similarity_update.contract import CONTRACT
from app.apis.entities.recipe_similarity_update.functions import execute
from app.apis.entities.recipe_similarity_update.schemas import (
    RecipeSimilarityRow,
...
def handle(
    ...
    """近似レシピ関係の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
