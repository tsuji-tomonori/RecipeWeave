...
from app.apis.entities.allergen_get.contract import CONTRACT
from app.apis.entities.allergen_get.functions import execute
from app.apis.entities.allergen_get.schemas import AllergenRow
...
def handle(
    ...
    """アレルゲン概念の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
