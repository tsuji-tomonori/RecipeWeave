...
from app.apis.entities.user_preference_get.contract import CONTRACT
from app.apis.entities.user_preference_get.functions import execute
from app.apis.entities.user_preference_get.schemas import UserPreferenceRow
...
def handle(
    ...
    """ユーザーの嗜好の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
