...
from app.apis.entities.generation_shard_get.contract import CONTRACT
from app.apis.entities.generation_shard_get.functions import execute
from app.apis.entities.generation_shard_get.schemas import GenerationShardRow
...
def handle(
    ...
    """列挙範囲・リース管理の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
