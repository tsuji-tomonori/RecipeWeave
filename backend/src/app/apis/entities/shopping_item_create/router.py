...
from app.apis.entities.shopping_item_create.contract import CONTRACT
from app.apis.entities.shopping_item_create.functions import execute
from app.apis.entities.shopping_item_create.schemas import ShoppingItemRow, ShoppingItemWrite
...
def handle(
    ...
    """買い物行の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
