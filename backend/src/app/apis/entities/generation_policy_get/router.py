...
from app.apis.entities.generation_policy_get.contract import CONTRACT
from app.apis.entities.generation_policy_get.functions import execute
from app.apis.entities.generation_policy_get.schemas import GenerationPolicyRow
...
def handle(
    ...
    """AI生成方針版の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
