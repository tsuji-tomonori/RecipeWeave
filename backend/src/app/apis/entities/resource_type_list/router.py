...
from app.apis.entities.resource_type_list.contract import CONTRACT
from app.apis.entities.resource_type_list.functions import execute
from app.apis.entities.resource_type_list.schemas import ResourceTypeRow
...
@router.get(
    ...
    response_model=list[ResourceTypeRow],
    responses={
...
def handle(
    ...
    """道具・設備・作業者種別の一覧。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
