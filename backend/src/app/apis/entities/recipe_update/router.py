...
from app.apis.entities.recipe_update.contract import CONTRACT
from app.apis.entities.recipe_update.functions import execute
from app.apis.entities.recipe_update.schemas import RecipeRow, RecipeWrite
...
def handle(
    ...
    """レシピ同一性の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
