...
from app.apis.entities.generation_result_get.contract import CONTRACT
from app.apis.entities.generation_result_get.functions import execute
from app.apis.entities.generation_result_get.schemas import GenerationResultRow
...
def handle(
    ...
    """生成結果の出自の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
