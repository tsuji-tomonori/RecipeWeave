...
from app.apis.entities.food_get.contract import CONTRACT
from app.apis.entities.food_get.functions import execute
from app.apis.entities.food_get.schemas import FoodRow
...
def handle(
    ...
    """購入・利用食材概念の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
