...
from app.apis.entities.operation_parameter_update.contract import CONTRACT
from app.apis.entities.operation_parameter_update.functions import execute
from app.apis.entities.operation_parameter_update.schemas import (
...
router = APIRouter(tags=["正規化データ: 動作パラメータ定義"])
...
@router.put(
    ...
    response_model=OperationParameterRow,
    responses={
...
def handle(
    ...
    row_id: UUID,
    payload: OperationParameterWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> OperationParameterRow:
    """動作パラメータ定義の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
