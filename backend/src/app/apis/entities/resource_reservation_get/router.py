...
from app.apis.entities.resource_reservation_get.contract import CONTRACT
from app.apis.entities.resource_reservation_get.functions import execute
from app.apis.entities.resource_reservation_get.schemas import ResourceReservationRow
...
def handle(
    ...
    """資源の予約の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
