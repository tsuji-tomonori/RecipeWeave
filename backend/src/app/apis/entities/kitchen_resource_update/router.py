...
from app.apis.entities.kitchen_resource_update.contract import CONTRACT
from app.apis.entities.kitchen_resource_update.functions import execute
from app.apis.entities.kitchen_resource_update.schemas import (
    KitchenResourceRow,
...
router = APIRouter(tags=["正規化データ: キッチンの実資源"])
...
@router.put(
    ...
    response_model=KitchenResourceRow,
    responses={
...
def handle(
    ...
    row_id: UUID,
    payload: KitchenResourceWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> KitchenResourceRow:
    """キッチンの実資源の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
