...
from app.apis.entities.generation_job_get.contract import CONTRACT
from app.apis.entities.generation_job_get.functions import execute
from app.apis.entities.generation_job_get.schemas import GenerationJobRow
...
def handle(
    ...
    """事前生成ジョブの取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
