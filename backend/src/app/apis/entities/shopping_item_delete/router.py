...
from app.apis.entities.shopping_item_delete.contract import CONTRACT
from app.apis.entities.shopping_item_delete.functions import execute
from app.apis.entities.shopping_item_delete.schemas import ShoppingItemRow
...
def handle(
    ...
    """買い物行の削除。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
