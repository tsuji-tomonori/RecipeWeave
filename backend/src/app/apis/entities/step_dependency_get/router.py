...
from app.apis.entities.step_dependency_get.contract import CONTRACT
from app.apis.entities.step_dependency_get.functions import execute
from app.apis.entities.step_dependency_get.schemas import StepDependencyRow
...
def handle(
    ...
    """工程依存辺の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
