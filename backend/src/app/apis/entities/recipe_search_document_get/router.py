...
from app.apis.entities.recipe_search_document_get.contract import CONTRACT
from app.apis.entities.recipe_search_document_get.functions import execute
from app.apis.entities.recipe_search_document_get.schemas import RecipeSearchDocumentRow
...
@router.get(
    ...
    response_model=RecipeSearchDocumentRow,
    responses={
...
def handle(
    ...
    """公開検索用文書の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
