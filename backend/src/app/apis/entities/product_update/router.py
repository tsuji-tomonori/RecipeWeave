...
from app.apis.entities.product_update.contract import CONTRACT
from app.apis.entities.product_update.functions import execute
from app.apis.entities.product_update.schemas import ProductRow, ProductWrite
...
def handle(
    ...
    """市販商品識別の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
