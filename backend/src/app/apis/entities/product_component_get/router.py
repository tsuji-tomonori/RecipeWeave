...
from app.apis.entities.product_component_get.contract import CONTRACT
from app.apis.entities.product_component_get.functions import execute
from app.apis.entities.product_component_get.schemas import ProductComponentRow
...
def handle(
    ...
    """セット内構成品の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
