...
from app.apis.entities.axis_update.contract import CONTRACT
from app.apis.entities.axis_update.functions import execute
from app.apis.entities.axis_update.schemas import AxisRow, AxisWrite
from app.core.db import DatabaseDependency
from app.core.entity_service import EntityService
from app.core.identity import IdentityDependency

router = APIRouter(tags=["正規化データ: 組み合わせ軸"])
...
def handle(
    ...
    """組み合わせ軸の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
