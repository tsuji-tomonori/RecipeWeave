...
from app.apis.entities.pantry_lot_update.contract import CONTRACT
from app.apis.entities.pantry_lot_update.functions import execute
from app.apis.entities.pantry_lot_update.schemas import PantryLotRow, PantryLotWrite
from app.core.db import DatabaseDependency
from app.core.entity_service import EntityService
from app.core.identity import IdentityDependency

router = APIRouter(tags=["正規化データ: 手持ち食材ロット"])
...
def handle(
    ...
    row_id: UUID,
    payload: PantryLotWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> PantryLotRow:
    """手持ち食材ロットの更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
