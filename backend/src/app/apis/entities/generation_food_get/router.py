...
from app.apis.entities.generation_food_get.contract import CONTRACT
from app.apis.entities.generation_food_get.functions import execute
from app.apis.entities.generation_food_get.schemas import GenerationFoodRow
...
def handle(
    ...
    """生成の食材入力の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
