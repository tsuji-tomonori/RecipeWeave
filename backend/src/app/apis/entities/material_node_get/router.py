...
from app.apis.entities.material_node_get.contract import CONTRACT
from app.apis.entities.material_node_get.functions import execute
from app.apis.entities.material_node_get.schemas import MaterialNodeRow
...
def handle(
    ...
    """材料・中間物節点の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
