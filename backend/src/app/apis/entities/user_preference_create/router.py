...
from app.apis.entities.user_preference_create.contract import CONTRACT
from app.apis.entities.user_preference_create.functions import execute
from app.apis.entities.user_preference_create.schemas import UserPreferenceRow, UserPreferenceWrite
...
def handle(
    ...
    """ユーザーの嗜好の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
