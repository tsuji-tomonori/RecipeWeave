...
from app.apis.entities.recipe_option_list.contract import CONTRACT
from app.apis.entities.recipe_option_list.functions import execute
from app.apis.entities.recipe_option_list.schemas import RecipeOptionRow
...
@router.get(
    ...
    response_model=list[RecipeOptionRow],
    responses={
...
def handle(
    ...
    """版の分類・特徴の一覧。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
