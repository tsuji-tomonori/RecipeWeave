...
from app.apis.entities.resource_reservation_update.contract import CONTRACT
from app.apis.entities.resource_reservation_update.functions import execute
from app.apis.entities.resource_reservation_update.schemas import (
...
@router.put(
    ...
    response_model=ResourceReservationRow,
    responses={
...
def handle(
    ...
    row_id: UUID,
    payload: ResourceReservationWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> ResourceReservationRow:
    """資源の予約の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
