...
from app.apis.entities.axis_get.contract import CONTRACT
from app.apis.entities.axis_get.functions import execute
from app.apis.entities.axis_get.schemas import AxisRow
...
def handle(
    ...
    """組み合わせ軸の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
