...
from app.apis.entities.step_dependency_update.contract import CONTRACT
from app.apis.entities.step_dependency_update.functions import execute
from app.apis.entities.step_dependency_update.schemas import StepDependencyRow, StepDependencyWrite
...
def handle(
    ...
    """工程依存辺の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
