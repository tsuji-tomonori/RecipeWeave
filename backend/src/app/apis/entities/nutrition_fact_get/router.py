...
from app.apis.entities.nutrition_fact_get.contract import CONTRACT
from app.apis.entities.nutrition_fact_get.functions import execute
from app.apis.entities.nutrition_fact_get.schemas import NutritionFactRow
...
def handle(
    ...
    """形態・商品別栄養値の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
