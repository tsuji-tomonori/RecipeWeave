...
from app.apis.entities.food_update.contract import CONTRACT
from app.apis.entities.food_update.functions import execute
from app.apis.entities.food_update.schemas import FoodRow, FoodWrite
...
def handle(
    ...
    """購入・利用食材概念の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
