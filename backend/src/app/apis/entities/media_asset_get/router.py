...
from app.apis.entities.media_asset_get.contract import CONTRACT
from app.apis.entities.media_asset_get.functions import execute
from app.apis.entities.media_asset_get.schemas import MediaAssetRow
...
def handle(
    ...
    """教育用動画等の版の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
