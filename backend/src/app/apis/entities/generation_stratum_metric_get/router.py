...
from app.apis.entities.generation_stratum_metric_get.contract import CONTRACT
from app.apis.entities.generation_stratum_metric_get.functions import execute
from app.apis.entities.generation_stratum_metric_get.schemas import GenerationStratumMetricRow
...
def handle(
    ...
    """採用率・飽和度の実測の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
