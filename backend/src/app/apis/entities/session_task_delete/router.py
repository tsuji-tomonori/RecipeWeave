...
from app.apis.entities.session_task_delete.contract import CONTRACT
from app.apis.entities.session_task_delete.functions import execute
from app.apis.entities.session_task_delete.schemas import SessionTaskRow
...
def handle(
    ...
    """展開済み工程の削除。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
