...
from app.apis.entities.food_alias_get.contract import CONTRACT
from app.apis.entities.food_alias_get.functions import execute
from app.apis.entities.food_alias_get.schemas import FoodAliasRow
...
def handle(
    ...
    """食材別名の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
