...
from app.apis.entities.unit_create.contract import CONTRACT
from app.apis.entities.unit_create.functions import execute
from app.apis.entities.unit_create.schemas import UnitRow, UnitWrite
from app.core.db import DatabaseDependency
from app.core.entity_service import EntityService
from app.core.identity import IdentityDependency

router = APIRouter(tags=["正規化データ: 単位"])
...
def handle(
    ...
    """単位の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
