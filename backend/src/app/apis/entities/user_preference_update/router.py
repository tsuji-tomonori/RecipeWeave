...
from app.apis.entities.user_preference_update.contract import CONTRACT
from app.apis.entities.user_preference_update.functions import execute
from app.apis.entities.user_preference_update.schemas import UserPreferenceRow, UserPreferenceWrite
...
def handle(
    ...
    """ユーザーの嗜好の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
