...
from app.apis.entities.compatibility_rule_get.contract import CONTRACT
from app.apis.entities.compatibility_rule_get.functions import execute
from app.apis.entities.compatibility_rule_get.schemas import CompatibilityRuleRow
...
def handle(
    ...
    """組み合わせ・公開ルールの取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
