...
from app.apis.entities.recipe_version_get.contract import CONTRACT
from app.apis.entities.recipe_version_get.functions import execute
from app.apis.entities.recipe_version_get.schemas import RecipeVersionRow
...
def handle(
    ...
    """レシピ内容版の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
