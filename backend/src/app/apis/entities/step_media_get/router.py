...
from app.apis.entities.step_media_get.contract import CONTRACT
from app.apis.entities.step_media_get.functions import execute
from app.apis.entities.step_media_get.schemas import StepMediaRow
...
def handle(
    ...
    """工程別メディア選択の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
