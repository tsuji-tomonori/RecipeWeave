...
from app.apis.entities.menu_ingredient_override_update.contract import CONTRACT
from app.apis.entities.menu_ingredient_override_update.functions import execute
from app.apis.entities.menu_ingredient_override_update.schemas import (
...
def handle(
    ...
    row_id: UUID,
    payload: MenuIngredientOverrideWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> MenuIngredientOverrideRow:
    """献立別材料確定の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
