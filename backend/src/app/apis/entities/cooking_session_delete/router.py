...
from app.apis.entities.cooking_session_delete.contract import CONTRACT
from app.apis.entities.cooking_session_delete.functions import execute
from app.apis.entities.cooking_session_delete.schemas import CookingSessionRow
...
def handle(
    ...
    """調理計画実行の削除。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
