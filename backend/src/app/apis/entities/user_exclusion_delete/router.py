...
from app.apis.entities.user_exclusion_delete.contract import CONTRACT
from app.apis.entities.user_exclusion_delete.functions import execute
from app.apis.entities.user_exclusion_delete.schemas import UserExclusionRow
...
def handle(
    ...
    """避けたい食材・物質の削除。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
