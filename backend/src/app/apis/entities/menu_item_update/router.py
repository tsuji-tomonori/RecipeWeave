...
from app.apis.entities.menu_item_update.contract import CONTRACT
from app.apis.entities.menu_item_update.functions import execute
from app.apis.entities.menu_item_update.schemas import MenuItemRow, MenuItemWrite
from app.core.db import DatabaseDependency
from app.core.entity_service import EntityService
from app.core.identity import IdentityDependency

router = APIRouter(tags=["正規化データ: 献立の料理"])
...
def handle(
    ...
    """献立の料理の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
