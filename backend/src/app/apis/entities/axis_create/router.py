...
from app.apis.entities.axis_create.contract import CONTRACT
from app.apis.entities.axis_create.functions import execute
from app.apis.entities.axis_create.schemas import AxisRow, AxisWrite
...
def handle(
    ...
    """組み合わせ軸の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
