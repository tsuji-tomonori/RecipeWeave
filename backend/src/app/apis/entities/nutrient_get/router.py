...
from app.apis.entities.nutrient_get.contract import CONTRACT
from app.apis.entities.nutrient_get.functions import execute
from app.apis.entities.nutrient_get.schemas import NutrientRow
...
def handle(
    ...
    """栄養成分種別の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
