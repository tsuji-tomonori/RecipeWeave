...
from app.apis.entities.scaling_rule_get.contract import CONTRACT
from app.apis.entities.scaling_rule_get.functions import execute
from app.apis.entities.scaling_rule_get.schemas import ScalingRuleRow
...
def handle(
    ...
    """人数変更規則の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
