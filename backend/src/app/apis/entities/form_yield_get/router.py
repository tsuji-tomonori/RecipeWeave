...
from app.apis.entities.form_yield_get.contract import CONTRACT
from app.apis.entities.form_yield_get.functions import execute
from app.apis.entities.form_yield_get.schemas import FormYieldRow
...
def handle(
    ...
    """処理歩留まりの取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
