...
from app.apis.entities.ingredient_total_list.contract import CONTRACT
from app.apis.entities.ingredient_total_list.functions import execute
from app.apis.entities.ingredient_total_list.schemas import IngredientTotalRow
...
@router.get(
    ...
    response_model=list[IngredientTotalRow],
    responses={
...
def handle(
    ...
    """献立材料集計結果の一覧。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
