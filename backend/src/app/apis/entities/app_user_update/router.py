...
from app.apis.entities.app_user_update.contract import CONTRACT
from app.apis.entities.app_user_update.functions import execute
from app.apis.entities.app_user_update.schemas import AppUserRow, AppUserWrite
from app.core.db import DatabaseDependency
from app.core.entity_service import EntityService
from app.core.identity import IdentityDependency

router = APIRouter(tags=["正規化データ: アプリ利用者"])
...
def handle(
    ...
    row_id: UUID,
    payload: AppUserWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> AppUserRow:
    """アプリ利用者の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
