...
from app.apis.entities.pantry_consumption_get.contract import CONTRACT
from app.apis.entities.pantry_consumption_get.functions import execute
from app.apis.entities.pantry_consumption_get.schemas import PantryConsumptionRow
...
@router.get(
    ...
    response_model=PantryConsumptionRow,
    responses={
...
def handle(
    ...
    """調理による在庫消費の冪等台帳の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
