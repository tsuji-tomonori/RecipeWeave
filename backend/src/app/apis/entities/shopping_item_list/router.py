...
from app.apis.entities.shopping_item_list.contract import CONTRACT
from app.apis.entities.shopping_item_list.functions import execute
from app.apis.entities.shopping_item_list.schemas import ShoppingItemRow
...
@router.get(
    ...
    response_model=list[ShoppingItemRow],
    responses={
...
def handle(
    ...
    """買い物行の一覧。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
