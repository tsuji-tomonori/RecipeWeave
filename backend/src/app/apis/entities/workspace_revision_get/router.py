...
from app.apis.entities.workspace_revision_get.contract import CONTRACT
from app.apis.entities.workspace_revision_get.functions import execute
from app.apis.entities.workspace_revision_get.schemas import WorkspaceRevisionRow
...
@router.get(
    ...
    response_model=WorkspaceRevisionRow,
    responses={
...
def handle(
    ...
    """利用者ワークスペースの原子的更新版の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
