...
from app.apis.entities.recipe_ingredient_update.contract import CONTRACT
from app.apis.entities.recipe_ingredient_update.functions import execute
from app.apis.entities.recipe_ingredient_update.schemas import (
    RecipeIngredientRow,
...
router = APIRouter(tags=["正規化データ: レシピ材料明細"])
...
@router.put(
    ...
    response_model=RecipeIngredientRow,
    responses={
...
def handle(
    ...
    row_id: UUID,
    payload: RecipeIngredientWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> RecipeIngredientRow:
    """レシピ材料明細の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
