...
from app.apis.entities.recipe_version_update.contract import CONTRACT
from app.apis.entities.recipe_version_update.functions import execute
from app.apis.entities.recipe_version_update.schemas import RecipeVersionRow, RecipeVersionWrite
...
def handle(
    ...
    """レシピ内容版の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
