...
from app.apis.entities.recipe_get.contract import CONTRACT
from app.apis.entities.recipe_get.functions import execute
from app.apis.entities.recipe_get.schemas import RecipeRow
...
def handle(
    ...
    """レシピ同一性の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
