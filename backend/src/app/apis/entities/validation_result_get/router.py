...
from app.apis.entities.validation_result_get.contract import CONTRACT
from app.apis.entities.validation_result_get.functions import execute
from app.apis.entities.validation_result_get.schemas import ValidationResultRow
...
def handle(
    ...
    """公開前評価結果の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
