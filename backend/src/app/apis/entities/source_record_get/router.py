...
from app.apis.entities.source_record_get.contract import CONTRACT
from app.apis.entities.source_record_get.functions import execute
from app.apis.entities.source_record_get.schemas import SourceRecordRow
...
def handle(
    ...
    """根拠資料の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
