...
from app.apis.entities.food_alias_update.contract import CONTRACT
from app.apis.entities.food_alias_update.functions import execute
from app.apis.entities.food_alias_update.schemas import FoodAliasRow, FoodAliasWrite
from app.core.db import DatabaseDependency
from app.core.entity_service import EntityService
from app.core.identity import IdentityDependency

router = APIRouter(tags=["正規化データ: 食材別名"])
...
def handle(
    ...
    row_id: UUID,
    payload: FoodAliasWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> FoodAliasRow:
    """食材別名の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
