...
from app.apis.entities.menu_delete.contract import CONTRACT
from app.apis.entities.menu_delete.functions import execute
from app.apis.entities.menu_delete.schemas import MenuRow
...
def handle(
    ...
    """献立の削除。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
