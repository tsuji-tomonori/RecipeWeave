...
from app.apis.entities.product_preparation_rule_get.contract import CONTRACT
from app.apis.entities.product_preparation_rule_get.functions import execute
from app.apis.entities.product_preparation_rule_get.schemas import ProductPreparationRuleRow
...
def handle(
    ...
    """商品固有の調理条件の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
