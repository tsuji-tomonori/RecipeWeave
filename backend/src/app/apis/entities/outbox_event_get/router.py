...
from app.apis.entities.outbox_event_get.contract import CONTRACT
from app.apis.entities.outbox_event_get.functions import execute
from app.apis.entities.outbox_event_get.schemas import OutboxEventRow
...
def handle(
    ...
    """検索・キャッシュ更新配信の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
