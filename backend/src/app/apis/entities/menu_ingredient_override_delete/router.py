...
from app.apis.entities.menu_ingredient_override_delete.contract import CONTRACT
from app.apis.entities.menu_ingredient_override_delete.functions import execute
from app.apis.entities.menu_ingredient_override_delete.schemas import MenuIngredientOverrideRow
...
def handle(
    ...
    """献立別材料確定の削除。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
