...
from app.apis.entities.receipt_line_update.contract import CONTRACT
from app.apis.entities.receipt_line_update.functions import execute
from app.apis.entities.receipt_line_update.schemas import ReceiptLineRow, ReceiptLineWrite
...
def handle(
    ...
    """レシートの商品候補と確定した在庫の対応の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
