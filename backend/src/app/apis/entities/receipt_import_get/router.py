...
from app.apis.entities.receipt_import_get.contract import CONTRACT
from app.apis.entities.receipt_import_get.functions import execute
from app.apis.entities.receipt_import_get.schemas import ReceiptImportRow
...
def handle(
    ...
    """レシート読取・在庫登録の処理単位の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
