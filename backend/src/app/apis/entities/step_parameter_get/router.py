...
from app.apis.entities.step_parameter_get.contract import CONTRACT
from app.apis.entities.step_parameter_get.functions import execute
from app.apis.entities.step_parameter_get.schemas import StepParameterRow
...
def handle(
    ...
    """工程の型付きパラメータの取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
