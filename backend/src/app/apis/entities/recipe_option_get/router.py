...
from app.apis.entities.recipe_option_get.contract import CONTRACT
from app.apis.entities.recipe_option_get.functions import execute
from app.apis.entities.recipe_option_get.schemas import RecipeOptionRow
...
def handle(
    ...
    """版の分類・特徴の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
