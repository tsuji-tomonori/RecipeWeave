...
from app.apis.entities.recipe_step_get.contract import CONTRACT
from app.apis.entities.recipe_step_get.functions import execute
from app.apis.entities.recipe_step_get.schemas import RecipeStepRow
...
def handle(
    ...
    """調理工程節点の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
