...
from app.apis.entities.operation_create.contract import CONTRACT
from app.apis.entities.operation_create.functions import execute
from app.apis.entities.operation_create.schemas import OperationRow, OperationWrite
from app.core.db import DatabaseDependency
from app.core.entity_service import EntityService
from app.core.identity import IdentityDependency

router = APIRouter(tags=["正規化データ: 標準調理動作"])
...
def handle(
    ...
    """標準調理動作の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
