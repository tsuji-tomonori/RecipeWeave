...
from app.apis.entities.generation_choice_list.contract import CONTRACT
from app.apis.entities.generation_choice_list.functions import execute
from app.apis.entities.generation_choice_list.schemas import GenerationChoiceRow
...
@router.get(
    ...
    response_model=list[GenerationChoiceRow],
    responses={
...
def handle(
    ...
    """生成軸の選択値の一覧。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
