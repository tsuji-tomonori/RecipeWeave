...
from app.apis.entities.menu_item_create.contract import CONTRACT
from app.apis.entities.menu_item_create.functions import execute
from app.apis.entities.menu_item_create.schemas import MenuItemRow, MenuItemWrite
...
def handle(
    ...
    """献立の料理の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
