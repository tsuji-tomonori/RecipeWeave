...
from app.apis.entities.operation_update.contract import CONTRACT
from app.apis.entities.operation_update.functions import execute
from app.apis.entities.operation_update.schemas import OperationRow, OperationWrite
...
def handle(
    ...
    """標準調理動作の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
