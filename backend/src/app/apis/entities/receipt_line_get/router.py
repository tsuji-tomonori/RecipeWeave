...
from app.apis.entities.receipt_line_get.contract import CONTRACT
from app.apis.entities.receipt_line_get.functions import execute
from app.apis.entities.receipt_line_get.schemas import ReceiptLineRow
...
def handle(
    ...
    """レシートの商品候補と確定した在庫の対応の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
