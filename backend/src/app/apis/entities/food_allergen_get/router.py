...
from app.apis.entities.food_allergen_get.contract import CONTRACT
from app.apis.entities.food_allergen_get.functions import execute
from app.apis.entities.food_allergen_get.schemas import FoodAllergenRow
...
def handle(
    ...
    """食材アレルゲン知識の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
