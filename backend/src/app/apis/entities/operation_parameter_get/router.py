...
from app.apis.entities.operation_parameter_get.contract import CONTRACT
from app.apis.entities.operation_parameter_get.functions import execute
from app.apis.entities.operation_parameter_get.schemas import OperationParameterRow
...
def handle(
    ...
    """動作パラメータ定義の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
