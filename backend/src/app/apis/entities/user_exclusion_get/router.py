...
from app.apis.entities.user_exclusion_get.contract import CONTRACT
from app.apis.entities.user_exclusion_get.functions import execute
from app.apis.entities.user_exclusion_get.schemas import UserExclusionRow
...
def handle(
    ...
    """避けたい食材・物質の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
