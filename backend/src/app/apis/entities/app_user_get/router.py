...
from app.apis.entities.app_user_get.contract import CONTRACT
from app.apis.entities.app_user_get.functions import execute
from app.apis.entities.app_user_get.schemas import AppUserRow
...
def handle(
    ...
    """アプリ利用者の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
