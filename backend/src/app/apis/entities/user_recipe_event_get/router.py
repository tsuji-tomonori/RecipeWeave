...
from app.apis.entities.user_recipe_event_get.contract import CONTRACT
from app.apis.entities.user_recipe_event_get.functions import execute
from app.apis.entities.user_recipe_event_get.schemas import UserRecipeEventRow
...
def handle(
    ...
    """提案・調理履歴の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
