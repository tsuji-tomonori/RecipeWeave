...
from app.apis.entities.menu_ingredient_override_create.contract import CONTRACT
from app.apis.entities.menu_ingredient_override_create.functions import execute
from app.apis.entities.menu_ingredient_override_create.schemas import (
...
def handle(
    ...
    """献立別材料確定の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
