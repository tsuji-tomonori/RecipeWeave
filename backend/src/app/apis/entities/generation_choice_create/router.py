...
from app.apis.entities.generation_choice_create.contract import CONTRACT
from app.apis.entities.generation_choice_create.functions import execute
from app.apis.entities.generation_choice_create.schemas import (
    GenerationChoiceRow,
...
def handle(
    ...
    payload: GenerationChoiceWrite,
) -> GenerationChoiceRow:
    """生成軸の選択値の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
