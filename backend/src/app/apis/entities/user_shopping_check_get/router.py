...
from app.apis.entities.user_shopping_check_get.contract import CONTRACT
from app.apis.entities.user_shopping_check_get.functions import execute
from app.apis.entities.user_shopping_check_get.schemas import UserShoppingCheckRow
...
def handle(
    ...
    """調理前の買い物確認の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
