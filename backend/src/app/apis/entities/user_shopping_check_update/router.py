...
from app.apis.entities.user_shopping_check_update.contract import CONTRACT
from app.apis.entities.user_shopping_check_update.functions import execute
from app.apis.entities.user_shopping_check_update.schemas import (
...
@router.put(
    ...
    response_model=UserShoppingCheckRow,
    responses={
...
def handle(
    ...
    row_id: UUID,
    payload: UserShoppingCheckWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> UserShoppingCheckRow:
    """調理前の買い物確認の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
