...
from app.apis.entities.recipe_ingredient_get.contract import CONTRACT
from app.apis.entities.recipe_ingredient_get.functions import execute
from app.apis.entities.recipe_ingredient_get.schemas import RecipeIngredientRow
...
def handle(
    ...
    """レシピ材料明細の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
