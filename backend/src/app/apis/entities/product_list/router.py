...
from app.apis.entities.product_list.contract import CONTRACT
from app.apis.entities.product_list.functions import execute
from app.apis.entities.product_list.schemas import ProductRow
...
def handle(
    ...
    """市販商品識別の一覧。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
