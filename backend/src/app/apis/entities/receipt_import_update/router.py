...
from app.apis.entities.receipt_import_update.contract import CONTRACT
from app.apis.entities.receipt_import_update.functions import execute
from app.apis.entities.receipt_import_update.schemas import ReceiptImportRow, ReceiptImportWrite
...
def handle(
    ...
    """レシート読取・在庫登録の処理単位の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
