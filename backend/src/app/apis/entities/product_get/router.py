...
from app.apis.entities.product_get.contract import CONTRACT
from app.apis.entities.product_get.functions import execute
from app.apis.entities.product_get.schemas import ProductRow
...
def handle(
    ...
    """市販商品識別の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
