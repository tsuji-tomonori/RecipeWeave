...
from app.apis.entities.food_form_update.contract import CONTRACT
from app.apis.entities.food_form_update.functions import execute
from app.apis.entities.food_form_update.schemas import FoodFormRow, FoodFormWrite
...
def handle(
    ...
    """食材形態の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
