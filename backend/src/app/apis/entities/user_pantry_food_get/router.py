...
from app.apis.entities.user_pantry_food_get.contract import CONTRACT
from app.apis.entities.user_pantry_food_get.functions import execute
from app.apis.entities.user_pantry_food_get.schemas import UserPantryFoodRow
...
def handle(
    ...
    """利用者が常備すると設定した食材の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
