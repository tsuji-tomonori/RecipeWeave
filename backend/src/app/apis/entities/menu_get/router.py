...
from app.apis.entities.menu_get.contract import CONTRACT
from app.apis.entities.menu_get.functions import execute
from app.apis.entities.menu_get.schemas import MenuRow
...
def handle(
    ...
    """献立の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
