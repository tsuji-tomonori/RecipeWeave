...
from app.apis.entities.candidate_attempt_update.contract import CONTRACT
from app.apis.entities.candidate_attempt_update.functions import execute
from app.apis.entities.candidate_attempt_update.schemas import (
    CandidateAttemptRow,
...
def handle(
    ...
    """試行済み設計点の台帳の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
