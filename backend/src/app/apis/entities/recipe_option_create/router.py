...
from app.apis.entities.recipe_option_create.contract import CONTRACT
from app.apis.entities.recipe_option_create.functions import execute
from app.apis.entities.recipe_option_create.schemas import RecipeOptionRow, RecipeOptionWrite
...
def handle(
    ...
    """版の分類・特徴の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
