...
from app.apis.entities.menu_update.contract import CONTRACT
from app.apis.entities.menu_update.functions import execute
from app.apis.entities.menu_update.schemas import MenuRow, MenuWrite
...
def handle(
    ...
    """献立の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
