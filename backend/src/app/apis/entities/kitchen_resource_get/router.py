...
from app.apis.entities.kitchen_resource_get.contract import CONTRACT
from app.apis.entities.kitchen_resource_get.functions import execute
from app.apis.entities.kitchen_resource_get.schemas import KitchenResourceRow
...
def handle(
    ...
    """キッチンの実資源の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
