...
from app.apis.entities.product_allergen_get.contract import CONTRACT
from app.apis.entities.product_allergen_get.functions import execute
from app.apis.entities.product_allergen_get.schemas import ProductAllergenRow
...
def handle(
    ...
    """商品表示アレルゲンの取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
