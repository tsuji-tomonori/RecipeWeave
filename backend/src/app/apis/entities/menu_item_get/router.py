...
from app.apis.entities.menu_item_get.contract import CONTRACT
from app.apis.entities.menu_item_get.functions import execute
from app.apis.entities.menu_item_get.schemas import MenuItemRow
...
def handle(
    ...
    """献立の料理の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
