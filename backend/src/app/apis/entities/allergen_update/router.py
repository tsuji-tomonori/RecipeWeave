...
from app.apis.entities.allergen_update.contract import CONTRACT
from app.apis.entities.allergen_update.functions import execute
from app.apis.entities.allergen_update.schemas import AllergenRow, AllergenWrite
from app.core.db import DatabaseDependency
from app.core.entity_service import EntityService
from app.core.identity import IdentityDependency

router = APIRouter(tags=["正規化データ: アレルゲン概念"])
...
def handle(
    ...
    row_id: UUID,
    payload: AllergenWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> AllergenRow:
    """アレルゲン概念の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
