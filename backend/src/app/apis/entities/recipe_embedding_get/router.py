...
from app.apis.entities.recipe_embedding_get.contract import CONTRACT
from app.apis.entities.recipe_embedding_get.functions import execute
from app.apis.entities.recipe_embedding_get.schemas import RecipeEmbeddingRow
...
def handle(
    ...
    """近似検索用特徴量の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
