...
from app.apis.entities.resource_type_get.contract import CONTRACT
from app.apis.entities.resource_type_get.functions import execute
from app.apis.entities.resource_type_get.schemas import ResourceTypeRow
...
def handle(
    ...
    """道具・設備・作業者種別の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
