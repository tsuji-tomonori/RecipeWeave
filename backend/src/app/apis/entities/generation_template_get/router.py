...
from app.apis.entities.generation_template_get.contract import CONTRACT
from app.apis.entities.generation_template_get.functions import execute
from app.apis.entities.generation_template_get.schemas import GenerationTemplateRow
...
def handle(
    ...
    """列挙テンプレート版の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
