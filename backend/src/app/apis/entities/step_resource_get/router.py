...
from app.apis.entities.step_resource_get.contract import CONTRACT
from app.apis.entities.step_resource_get.functions import execute
from app.apis.entities.step_resource_get.schemas import StepResourceRow
...
def handle(
    ...
    """工程の資源要求の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
