...
from app.apis.entities.scaling_point_create.contract import CONTRACT
from app.apis.entities.scaling_point_create.functions import execute
from app.apis.entities.scaling_point_create.schemas import ScalingPointRow, ScalingPointWrite
...
@router.post(
    ...
    response_model=ScalingPointRow,
    responses={
...
def handle(
    ...
    payload: ScalingPointWrite,
) -> ScalingPointRow:
    """検証済み換算点の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
