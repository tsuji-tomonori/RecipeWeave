...
from app.apis.entities.receipt_line_list.contract import CONTRACT
from app.apis.entities.receipt_line_list.functions import execute
from app.apis.entities.receipt_line_list.schemas import ReceiptLineRow
...
@router.get(
    ...
    response_model=list[ReceiptLineRow],
    responses={
...
def handle(
    ...
    """レシートの商品候補と確定した在庫の対応の一覧。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
