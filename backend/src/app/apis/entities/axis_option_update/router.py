...
from app.apis.entities.axis_option_update.contract import CONTRACT
from app.apis.entities.axis_option_update.functions import execute
from app.apis.entities.axis_option_update.schemas import AxisOptionRow, AxisOptionWrite
...
def handle(
    ...
    """軸候補値の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
