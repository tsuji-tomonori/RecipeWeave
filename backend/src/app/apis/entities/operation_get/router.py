...
from app.apis.entities.operation_get.contract import CONTRACT
from app.apis.entities.operation_get.functions import execute
from app.apis.entities.operation_get.schemas import OperationRow
...
def handle(
    ...
    """標準調理動作の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
