...
from app.apis.entities.conversion_get.contract import CONTRACT
from app.apis.entities.conversion_get.functions import execute
from app.apis.entities.conversion_get.schemas import ConversionRow
...
def handle(
    ...
    """食材形態別換算の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
