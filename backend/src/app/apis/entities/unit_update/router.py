...
from app.apis.entities.unit_update.contract import CONTRACT
from app.apis.entities.unit_update.functions import execute
from app.apis.entities.unit_update.schemas import UnitRow, UnitWrite
...
def handle(
    ...
    """単位の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
