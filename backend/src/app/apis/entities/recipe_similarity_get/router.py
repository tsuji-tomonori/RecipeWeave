...
from app.apis.entities.recipe_similarity_get.contract import CONTRACT
from app.apis.entities.recipe_similarity_get.functions import execute
from app.apis.entities.recipe_similarity_get.schemas import RecipeSimilarityRow
...
def handle(
    ...
    """近似レシピ関係の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
