...
from app.apis.entities.food_identity_member_create.contract import CONTRACT
from app.apis.entities.food_identity_member_create.functions import execute
from app.apis.entities.food_identity_member_create.schemas import (
...
def handle(
    ...
    payload: FoodIdentityMemberWrite,
) -> FoodIdentityMemberRow:
    """購買食品から同一性への対応の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
