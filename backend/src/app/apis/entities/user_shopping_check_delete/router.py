...
from app.apis.entities.user_shopping_check_delete.contract import CONTRACT
from app.apis.entities.user_shopping_check_delete.functions import execute
from app.apis.entities.user_shopping_check_delete.schemas import UserShoppingCheckRow
...
def handle(
    ...
    """調理前の買い物確認の削除。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
