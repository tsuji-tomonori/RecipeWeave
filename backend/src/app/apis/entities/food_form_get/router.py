...
from app.apis.entities.food_form_get.contract import CONTRACT
from app.apis.entities.food_form_get.functions import execute
from app.apis.entities.food_form_get.schemas import FoodFormRow
...
def handle(
    ...
    """食材形態の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
