...
from app.apis.entities.menu_list.contract import CONTRACT
from app.apis.entities.menu_list.functions import execute
from app.apis.entities.menu_list.schemas import MenuRow
...
def handle(
    ...
    """献立の一覧。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
