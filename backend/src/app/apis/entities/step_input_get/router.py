...
from app.apis.entities.step_input_get.contract import CONTRACT
from app.apis.entities.step_input_get.functions import execute
from app.apis.entities.step_input_get.schemas import StepInputRow
...
def handle(
    ...
    """工程への材料受渡しの取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
