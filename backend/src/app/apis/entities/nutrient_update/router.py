...
from app.apis.entities.nutrient_update.contract import CONTRACT
from app.apis.entities.nutrient_update.functions import execute
from app.apis.entities.nutrient_update.schemas import NutrientRow, NutrientWrite
...
def handle(
    ...
    """栄養成分種別の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
