...
from app.apis.entities.food_axis_option_get.contract import CONTRACT
from app.apis.entities.food_axis_option_get.functions import execute
from app.apis.entities.food_axis_option_get.schemas import FoodAxisOptionRow
...
def handle(
    ...
    """食材の分類属性の取得。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
