...
from app.apis.entities.validation_result_create.contract import CONTRACT
from app.apis.entities.validation_result_create.functions import execute
from app.apis.entities.validation_result_create.schemas import (
    ValidationResultRow,
...
def handle(
    ...
    payload: ValidationResultWrite,
) -> ValidationResultRow:
    """公開前評価結果の作成。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
