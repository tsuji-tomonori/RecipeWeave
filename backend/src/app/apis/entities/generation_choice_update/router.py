...
from app.apis.entities.generation_choice_update.contract import CONTRACT
from app.apis.entities.generation_choice_update.functions import execute
from app.apis.entities.generation_choice_update.schemas import (
    GenerationChoiceRow,
...
def handle(
    ...
    """生成軸の選択値の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
