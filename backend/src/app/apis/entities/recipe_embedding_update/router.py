...
from app.apis.entities.recipe_embedding_update.contract import CONTRACT
from app.apis.entities.recipe_embedding_update.functions import execute
from app.apis.entities.recipe_embedding_update.schemas import (
    RecipeEmbeddingRow,
...
router = APIRouter(tags=["正規化データ: 近似検索用特徴量"])
...
@router.put(
    ...
    response_model=RecipeEmbeddingRow,
    responses={
...
def handle(
    ...
    row_id: UUID,
    payload: RecipeEmbeddingWrite,
    if_match: Annotated[str | None, Header(alias="If-Match")] = None,
) -> RecipeEmbeddingRow:
    """近似検索用特徴量の更新。認証情報は依存から取得し、本人所有または管理者権限を検査する。"""
