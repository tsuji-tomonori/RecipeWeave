...
from app.apis.workspace.undo_receipt.contract import CONTRACT
from app.apis.workspace.undo_receipt.functions import execute
from app.apis.workspace.undo_receipt.schemas import AppSnapshot, RevisionRequest
...
def handle(
    ...
    """レシート登録を取り消す。呼出元が送った利用者IDは使用しない。"""
